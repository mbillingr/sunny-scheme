...
pub fn __for_minus_each(args: &[Scm]) -> Scm {
    {
        ...
        if ({
            // (any? null? seq*)
            Scm::func(any_p).invoke(&[Scm::func(imports::null_p), seq_star_.clone()])
        })
        .is_true()
        {
            Scm::Nil
        } else {
            {
                ...
                };
                {
                    ...
                    Scm::func(__for_minus_each).invoke(&[proc.clone(), {
                        // (map-1 cdr seq*)
                        Scm::func(map_minus_1).invoke(&[Scm::func(imports::cdr), seq_star_.clone()])
                    }])
                }
            }
        }
        ...
        } else {
            {
                ...
                Scm::func(imports::cons).invoke(&[
                    ...
                    },
                    {
                        ...
                        Scm::func(__map).invoke(&[func.clone(), {
                            // (map-1 cdr seq*)
                            Scm::func(map_minus_1)
                                .invoke(&[Scm::func(imports::cdr), seq_star_.clone()])
                        }])
                    },
                ])
            }
...
pub fn append(args: &[Scm]) -> Scm {
    {
        ...
        let seq = Scm::list(&args[0..]);
        {
            ...
            Scm::func(fold_minus_right).invoke(&[Scm::func(append2), Scm::Nil, seq.clone()])
        }
    }
    .into()
}
...
pub fn for_minus_each(args: &[Scm]) -> Scm {
    {
        ...
        {
            // (_for-each proc seq*)
            Scm::func(__for_minus_each).invoke(&[proc.clone(), seq_star_.clone()])
        }
    }
    .into()
}
...
pub fn list_minus_copy(args: &[Scm]) -> Scm {
    {
        ...
        let seq = args[0].clone();
        {
            ...
            Scm::func(fold_minus_right).invoke(&[Scm::func(imports::cons), Scm::Nil, seq.clone()])
        }
    }
    .into()
}
...
pub fn map(args: &[Scm]) -> Scm {
    {
        ...
        {
            // (_map func seq*)
            Scm::func(__map).invoke(&[func.clone(), seq_star_.clone()])
        }
    }
    .into()
}
