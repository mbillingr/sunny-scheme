                        ...
                        let node = args[1].clone();
                        {
                            // (letrec ((repr (lambda () (list (quote COMMENT) comment (node (quote repr))))) (transform (lambda (func) (func self (lambda () (make-comment comment (node (quote transform) func)))))) (free-vars (lambda () (node (quote free-vars)))) (gen-rust (lambda (module) (rust-block module (lambda () (println module) (print module "// ") (showln module comment) (node (quote gen-rust) module))))) (gen-rust-inner (lambda (module) (println module) (print module "// ") (showln module comment) (node (quote gen-rust-inner) module))) (self (lambda (msg . args) (cond ((eq? (quote repr) msg) (repr)) ((eq? (quote transform) msg) (transform (car args))) ((eq? (quote free-vars) msg) (free-vars)) ((eq? (quote kind) msg) (quote COMMENT)) ((eq? (quote gen-rust) msg) (gen-rust (car args))) ((eq? (quote gen-rust-inner) msg) (gen-rust-inner (car args))) ((eq? (quote inner) msg) node) (else (error "Unknown message COMMENT" msg)))))) self)
                            {
                                ...
                                self_.set({
                                    ...
                                    let gen_minus_rust_minus_inner =
                                        gen_minus_rust_minus_inner.clone();
                                    let node = node.clone();
                                    Scm::func(move |args: &[Scm]| {
                                        if args.len() < 1 {
                                        ...
                                        let args_ = Scm::list(&args[1..]);
                                        {
                                            ...
                                            .is_true()
                                            {
                                                ...
                                                imports::eq_p
                                                    .with(|value| value.get())
                                                    .invoke(&[Scm::symbol("inner"), msg.clone()])
                                            })
                                            .is_true()
                                            {
                                                node.clone()
                                            ...
                                            {
                                                {
                                                    ...
                                                    imports::print.with(|value| value.get()).invoke(
                                                        &[module.clone(), Scm::from("Scm::True")],
                                                    )
                                                }
                                            } else if ({
                                                // (eq? val #f)
                                            ...
                                            {
                                                {
                                                    ...
                                                    imports::print.with(|value| value.get()).invoke(
                                                        &[module.clone(), Scm::from("Scm::False")],
                                                    )
                                                }
                                            } else if ({
                                                // (symbol? val)
...
let gen_minus_rust = Scm::uninitialized().into_boxed();
let self_ = Scm::uninitialized().into_boxed();
repr.set({let name = name.clone();let val = val.clone();Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}{
...
gen_minus_rust.set({let var = var.clone();let name = name.clone();let val = val.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();{
// (cond ...)
if ({
// (global-variable? var)
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("definition! of non-global variable")])}}}})});
self_.set({let repr = repr.clone();let transform = transform.clone();let free_minus_vars = free_minus_vars.clone();let gen_minus_rust = gen_minus_rust.clone();Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let msg = args[0].clone();let args_ = Scm::list(&args[1..]);{
// (cond ...)
if ({
// (eq? (quote repr) msg)
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message DEFINITION"),msg.clone()])}}}})});
self_.get()}}})}))
        };
        {
...
gen_minus_rust_minus_inner.set({let params = params.clone();let args_ = args_.clone();let body = body.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();{
...
gen_minus_params.set({let module = module.clone();let gen_minus_params = gen_minus_params.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let p_star_ = args[0].clone();if ({
// (pair? p*)
...
self_.set({let repr = repr.clone();let transform = transform.clone();let free_minus_vars = free_minus_vars.clone();let gen_minus_rust = gen_minus_rust.clone();let gen_minus_rust_minus_inner = gen_minus_rust_minus_inner.clone();Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let msg = args[0].clone();let args_ = Scm::list(&args[1..]);{
// (cond ...)
if ({
// (eq? (quote repr) msg)
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("repr"),msg.clone()])}).is_true() {{
...
free_minus_vars_minus_args.set({let free_minus_vars_minus_args = free_minus_vars_minus_args.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let args_ = args[0].clone();if ({
// (null? args)
...
let gen_minus_rust = Scm::uninitialized().into_boxed();
let self_ = Scm::uninitialized().into_boxed();
repr.set({let function = function.clone();Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}{
// (list (quote CLOSURE) function)
imports::list.with(|value| value.get()).invoke(&[Scm::symbol("CLOSURE"),function.clone()])}})});
transform.set({let self_ = self_.clone();let function = function.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let func = args[0].clone();{
...
function.clone().invoke(&[Scm::symbol("transform"),func.clone()])}])}})}])}})});
free_minus_vars.set({let function = function.clone();Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}{
// (function (quote free-vars))
function.clone().invoke(&[Scm::symbol("free-vars")])}})});
prepare_minus_closure.set({let prepare_minus_closure = prepare_minus_closure.clone();Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let module = args[0].clone();let free_minus_vars = args[1].clone();if ({
// (pair? free-vars)
...
gen_minus_rust.set({let prepare_minus_closure = prepare_minus_closure.clone();let free_minus_vars = free_minus_vars.clone();let function = function.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();{
...
// (print module ")")
imports::print.with(|value| value.get()).invoke(&[module.clone(),Scm::from(")")])}}})}])}})});
self_.set({let repr = repr.clone();let transform = transform.clone();let free_minus_vars = free_minus_vars.clone();let gen_minus_rust = gen_minus_rust.clone();let function = function.clone();Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let msg = args[0].clone();let args_ = Scm::list(&args[1..]);{
// (cond ...)
if ({
// (eq? (quote repr) msg)
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("repr"),msg.clone()])}).is_true() {{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message CLOSURE"),msg.clone()])}}}})});
self_.get()}}})}))
        };
        {
...
// (body (quote free-vars))
body.clone().invoke(&[Scm::symbol("free-vars")])},params.clone()])}})});
gen_minus_rust.set({let params = params.clone();let body = body.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();{
...
{let gen_minus_params = Scm::uninitialized().into_boxed();
gen_minus_params.set({let module = module.clone();let gen_minus_params = gen_minus_params.clone();Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let p_star_ = args[0].clone();let k = args[1].clone();if ({
// (pair? p*)
imports::pair_p.with(|value| value.get()).invoke(&[p_star_.clone()])}).is_true() {{{
// (print module "let ")
imports::print.with(|value| value.get()).invoke(&[module.clone(),Scm::from("let ")])};{
...
// (body (quote gen-rust) module)
body.clone().invoke(&[Scm::symbol("gen-rust"),module.clone()])}}})}])}}}})});
self_.set({let repr = repr.clone();let transform = transform.clone();let free_minus_vars = free_minus_vars.clone();let gen_minus_rust = gen_minus_rust.clone();let params = params.clone();let vars = vars.clone();let body = body.clone();Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let msg = args[0].clone();let args_ = Scm::list(&args[1..]);{
// (cond ...)
if ({
// (eq? (quote repr) msg)
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("repr"),msg.clone()])}).is_true() {{
...
gen_minus_rust.set({let params = params.clone();let body = body.clone();let vararg = vararg.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();{
...
{let gen_minus_params = Scm::uninitialized().into_boxed();
gen_minus_params.set({let module = module.clone();let gen_minus_params = gen_minus_params.clone();let vararg = vararg.clone();Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let p_star_ = args[0].clone();let k = args[1].clone();if ({
// (pair? p*)
imports::pair_p.with(|value| value.get()).invoke(&[p_star_.clone()])}).is_true() {{{
...
// (body (quote gen-rust) module)
body.clone().invoke(&[Scm::symbol("gen-rust"),module.clone()])}}})}])}}}})});
self_.set({let repr = repr.clone();let transform = transform.clone();let free_minus_vars = free_minus_vars.clone();let gen_minus_rust = gen_minus_rust.clone();let params = params.clone();let vararg = vararg.clone();let vars = vars.clone();let varvar = varvar.clone();let body = body.clone();Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let msg = args[0].clone();let args_ = Scm::list(&args[1..]);{
// (cond ...)
if ({
// (eq? (quote repr) msg)
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("repr"),msg.clone()])}).is_true() {{
...
imports::rust_minus_block.with(|value| value.get()).invoke(&[module.clone(),{let globals = globals.clone();let module = module.clone();Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}{if ({
...
// (func self (lambda () self))
func.clone().invoke(&[self_.get(),{let self_ = self_.clone();Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}self_.get()})}])}})});
...
imports::rustify_minus_identifier.with(|value| value.get()).invoke(&[exname.clone()])},Scm::from(";")])}}})});
self_.set({let repr = repr.clone();let transform = transform.clone();let gen_minus_rust = gen_minus_rust.clone();Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let msg = args[0].clone();let args_ = Scm::list(&args[1..]);{
// (cond ...)
if ({
// (eq? (quote repr) msg)
...
let gen_minus_rust = Scm::uninitialized().into_boxed();
let self_ = Scm::uninitialized().into_boxed();
repr.set({let name = name.clone();let cases = cases.clone();Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}{
// (list (quote TESTSUITE) name cases)
imports::list.with(|value| value.get()).invoke(&[Scm::symbol("TESTSUITE"),name.clone(),cases.clone()])}})});
transform.set({let self_ = self_.clone();let name = name.clone();let cases = cases.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let func = args[0].clone();{
...
c.clone().invoke(&[Scm::symbol("transform"),func.clone()])}})},cases.clone()])}])}})}])}})});
...
gen_minus_rust.set({let cases = cases.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();{{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message TESTSUITE"),msg.clone()])}}}})});
self_.get()}}})}))
        };
        {
