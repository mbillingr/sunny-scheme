...
pub fn initialize() {
    ...
    crate::sunny::variable::initialize();
    {
        ...
        };
        {
            ...
            globals::make_minus_comment.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let comment = args[0].clone();let node = args[1].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message COMMENT"),msg.clone()])}}}})});self_.get()}}}}}}}}}}})}))
        ...
        {
            // (define (make-nop) ...)
            globals::make_minus_nop.with(|value| value.set({// Closure
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message NOP"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_constant.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let val = args[0].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message CONSTANT"),msg.clone()])}}}})});self_.get()}}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_reference.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name = args[0].clone();let var = args[1].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message REFERENCE"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_assignment.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let name = args[0].clone();let var = args[1].clone();let val = args[2].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message ASSIGNMENT"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_definition.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let name = args[0].clone();let var = args[1].clone();let val = args[2].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message DEFINITION"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_alternative.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let condition = args[0].clone();let consequent = args[1].clone();let alternative = args[2].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message ALTERNATIVE"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_sequence.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let first = args[0].clone();let next = args[1].clone();{
...
// (make-sequence a b)
globals::make_minus_sequence.with(|value| value.get()).invoke(&[a.clone(),b.clone()])}}}}})}])}})});free_minus_vars.set({// Closure
let first = first.clone();let next = next.clone();Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message SEQUENCE"),msg.clone()])}}}})});self_.get()}}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_application.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let func = args[0].clone();let args_ = args[1].clone();let tail_p = args[2].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message APPLICATION"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_null_minus_arg.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message NULL-ARG"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_args.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let arg = args[0].clone();let next = args[1].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message ARG"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_fixlet.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 4{panic!("invalid arity")}let params = args[0].clone();let vars = args[1].clone();let args_ = args[2].clone();let body = args[3].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message FIXLET"),msg.clone()])}}}})});self_.get()}}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_closure.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let function = args[0].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message CLOSURE"),msg.clone()])}}}})});self_.get()}}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_abstraction.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let params = args[0].clone();let vars = args[1].clone();let body = args[2].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message ABSTRACTION"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_vararg_minus_abstraction.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 5{panic!("invalid arity")}let params = args[0].clone();let vararg = args[1].clone();let vars = args[2].clone();let varvar = args[3].clone();let body = args[4].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message VARARG-ABSTRACTION"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_program.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 5{panic!("invalid arity")}let globals = args[0].clone();let imports = args[1].clone();let init = args[2].clone();let body = args[3].clone();let libraries = args[4].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message PROGRAM"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_library.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 6{panic!("invalid arity")}let name = args[0].clone();let globals = args[1].clone();let init = args[2].clone();let body = args[3].clone();let imports = args[4].clone();let exports = args[5].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message LIBRARY"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_boxify.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name = args[0].clone();let body = args[1].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message BOXIFY"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_export.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let env = args[0].clone();let name = args[1].clone();let exname = args[2].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message EXPORT"),msg.clone()])}}}})});self_.get()}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_import.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let lib = args[0].clone();{
...
let lib = lib.clone();Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}{
// (make-import lib)
globals::make_minus_import.with(|value| value.get()).invoke(&[lib.clone()])}})}])}})});free_minus_vars.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}{
// (make-set)
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message IMPORT"),msg.clone()])}}}})});self_.get()}}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_import_minus_only.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let lib = args[0].clone();let names = args[1].clone();{
...
globals::make_minus_import_minus_only.with(|value| value.get()).invoke(&[lib.clone(),names.clone()])}})}])}})});free_minus_vars.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}{
// (make-set)
imports::make_minus_set.with(|value| value.get()).invoke(&[])}})});gen_minus_libname.set({// Closure
let gen_minus_libname = gen_minus_libname.clone();Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let module = args[0].clone();let lib = args[1].clone();if ({
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message IMPORT"),msg.clone()])}}}})});self_.get()}}}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_testcase.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let description = args[0].clone();let body = args[1].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message TESTCASE"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_testsuite.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name = args[0].clone();let cases = args[1].clone();{
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message TESTSUITE"),msg.clone()])}}}})});self_.get()}}}}}}}}}})}))
        };
        {
            ...
            globals::make_minus_assert.with(|value| value.set({// Closure
Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let condition = args[0].clone();{
