...
pub use crate::scheme::cxr::exports::{caadr, cadar, caddr, cdadr, cddar, cdddr, cadddr, };
pub use crate::scheme::read::exports::{read, };
pub use crate::scheme::file::exports::{file_minus_exists_p, open_minus_input_minus_file, open_minus_output_minus_file, };
pub use crate::chibi::filesystem::exports::*;
pub use crate::sunny::utils::exports::*;
}

pub mod exports{pub use super::globals::rust_minus_gen_minus_in_minus_module as rust_minus_gen_minus_in_minus_module;
pub use super::globals::scm_minus__g_ast as scm_minus__g_ast;
}
...
globals::scm_minus__g_ast.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let exp_star_ = args[0].clone();
...
globals::library_minus_name.with(|value| value.get()).invoke(&[
// (car exp*)
imports::car.with(|value| value.get()).invoke(&[exp_star_.clone(), ]), ]), 
// (library-decls (car exp*))
globals::library_minus_decls.with(|value| value.get()).invoke(&[
// (car exp*)
imports::car.with(|value| value.get()).invoke(&[exp_star_.clone(), ]), ]), 
// (list (quote ()))
imports::list.with(|value| value.get()).invoke(&[Scm::Nil, ]), ])} else {
// (program->ast exp*)
globals::program_minus__g_ast.with(|value| value.get()).invoke(&[exp_star_.clone(), ])}}})}));
...
globals::library_minus__g_ast.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let name = args[0].clone();let exp_star_ = args[1].clone();let library_minus_env = args[2].clone();
...
globals::library_minus_decls_minus__g_ast.with(|value| value.get()).invoke(&[name.clone(), exp_star_.clone(), 
// (make-set)
globals::make_minus_set.with(|value| value.get()).invoke(&[]), 
// (make-nop)
globals::make_minus_nop.with(|value| value.get()).invoke(&[]), 
// (make-global-env)
globals::make_minus_global_minus_env.with(|value| value.get()).invoke(&[]), library_minus_env.clone(), Scm::Nil, Scm::Nil, ])}})}));
...
globals::library_minus_decls_minus__g_ast.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 8{panic!("invalid arity")}let name = args[0].clone();let exp_star_ = args[1].clone();let init = args[2].clone();let body = args[3].clone();let global_minus_env = args[4].clone();let library_minus_env = args[5].clone();let imports = args[6].clone();let exports = args[7].clone();
// (letrec () (cond ((null? exp*) (make-library name (cdr global-env) init body imports exports)) ((eq? (quote export) (caar exp*)) (library-decls->ast name (cdr exp*) init body global-env library-env imports (append exports (sexpr->export (cdar exp*) global-env)))) ((import? (car exp*)) (register-libraries (import-libnames (car exp*)) library-env) (library-decls->ast name (cdr exp*) (set-add* init (import-libnames (car exp*))) body global-env library-env (append imports (sexpr->import (cdar exp*) global-env)) exports)) ((eq? (quote begin) (caar exp*)) (library-decls->ast name (cdr exp*) init (make-sequence body (sexpr->sequence (cdar exp*) global-env #f)) global-env library-env imports exports))))
{
// (cond ((null? exp*) (make-library name (cdr global-env) init body imports exports)) ((eq? (quote export) (caar exp*)) (library-decls->ast name (cdr exp*) init body global-env library-env imports (append exports (sexpr->export (cdar exp*) global-env)))) ((import? (car exp*)) (register-libraries (import-libnames (car exp*)) library-env) (library-decls->ast name (cdr exp*) (set-add* init (import-libnames (car exp*))) body global-env library-env (append imports (sexpr->import (cdar exp*) global-env)) exports)) ((eq? (quote begin) (caar exp*)) (library-decls->ast name (cdr exp*) init (make-sequence body (sexpr->sequence (cdar exp*) global-env #f)) global-env library-env imports exports)))
if (
// (null? exp*)
imports::null_p.with(|value| value.get()).invoke(&[exp_star_.clone(), ])).is_true() {
// (make-library name (cdr global-env) init body imports exports)
globals::make_minus_library.with(|value| value.get()).invoke(&[name.clone(), 
// (cdr global-env)
imports::cdr.with(|value| value.get()).invoke(&[global_minus_env.clone(), ]), init.clone(), body.clone(), imports.clone(), exports.clone(), ])} else {if (
// (eq? (quote export) (caar exp*))
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("export"), 
// (caar exp*)
imports::caar.with(|value| value.get()).invoke(&[exp_star_.clone(), ]), ])).is_true() {
// (library-decls->ast name (cdr exp*) init body global-env library-env imports (append exports (sexpr->export (cdar exp*) global-env)))
globals::library_minus_decls_minus__g_ast.with(|value| value.get()).invoke(&[name.clone(), 
// (cdr exp*)
imports::cdr.with(|value| value.get()).invoke(&[exp_star_.clone(), ]), init.clone(), body.clone(), global_minus_env.clone(), library_minus_env.clone(), imports.clone(), 
// (append exports (sexpr->export (cdar exp*) global-env))
globals::append.with(|value| value.get()).invoke(&[exports.clone(), 
// (sexpr->export (cdar exp*) global-env)
globals::sexpr_minus__g_export.with(|value| value.get()).invoke(&[
// (cdar exp*)
imports::cdar.with(|value| value.get()).invoke(&[exp_star_.clone(), ]), global_minus_env.clone(), ]), ]), ])} else {if (
// (import? (car exp*))
globals::import_p.with(|value| value.get()).invoke(&[
// (car exp*)
imports::car.with(|value| value.get()).invoke(&[exp_star_.clone(), ]), ])).is_true() {{
...
globals::import_minus_libnames.with(|value| value.get()).invoke(&[
// (car exp*)
imports::car.with(|value| value.get()).invoke(&[exp_star_.clone(), ]), ]), library_minus_env.clone(), ]);
...
globals::import_minus_libnames.with(|value| value.get()).invoke(&[
// (car exp*)
imports::car.with(|value| value.get()).invoke(&[exp_star_.clone(), ]), ]), ]), body.clone(), global_minus_env.clone(), library_minus_env.clone(), 
// (append imports (sexpr->import (cdar exp*) global-env))
globals::append.with(|value| value.get()).invoke(&[imports.clone(), 
// (sexpr->import (cdar exp*) global-env)
globals::sexpr_minus__g_import.with(|value| value.get()).invoke(&[
// (cdar exp*)
imports::cdar.with(|value| value.get()).invoke(&[exp_star_.clone(), ]), global_minus_env.clone(), ]), ]), exports.clone(), ])}} else {if (
...
globals::library_minus_decls_minus__g_ast.with(|value| value.get()).invoke(&[name.clone(), 
// (cdr exp*)
imports::cdr.with(|value| value.get()).invoke(&[exp_star_.clone(), ]), init.clone(), 
// (make-sequence body (sexpr->sequence (cdar exp*) global-env #f))
globals::make_minus_sequence.with(|value| value.get()).invoke(&[body.clone(), 
// (sexpr->sequence (cdar exp*) global-env #f)
globals::sexpr_minus__g_sequence.with(|value| value.get()).invoke(&[
// (cdar exp*)
imports::cdar.with(|value| value.get()).invoke(&[exp_star_.clone(), ]), global_minus_env.clone(), Scm::False, ]), ]), global_minus_env.clone(), library_minus_env.clone(), imports.clone(), exports.clone(), ])} else {Scm::symbol("*UNSPECIFIED*")}}}}}})}));
...
globals::wrap_minus_sexpr.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let exp = args[0].clone();let node = args[1].clone();
// (letrec () (make-comment exp node))
{
// (make-comment exp node)
globals::make_minus_comment.with(|value| value.get()).invoke(&[exp.clone(), node.clone(), ])}})}));
// (define (sexpr->constant exp env) (make-constant exp))
globals::sexpr_minus__g_constant.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let exp = args[0].clone();let env = args[1].clone();
// (letrec () (make-constant exp))
{
// (make-constant exp)
globals::make_minus_constant.with(|value| value.get()).invoke(&[exp.clone(), ])}})}));
// (define (sexpr->reference name env) (let ((var (ensure-var! name env))) (make-reference name var)))
globals::sexpr_minus__g_reference.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name = args[0].clone();let env = args[1].clone();
// (letrec () (let ((var (ensure-var! name env))) (make-reference name var)))
{
// (let ((var (ensure-var! name env))) (make-reference name var))
{let [var, ] = [
// (ensure-var! name env)
globals::ensure_minus_var_i.with(|value| value.get()).invoke(&[name.clone(), env.clone(), ]), ];
// (make-reference name var)
globals::make_minus_reference.with(|value| value.get()).invoke(&[name.clone(), var.clone(), ])}}})}));
...
globals::sexpr_minus__g_assignment.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let name = args[0].clone();let exp = args[1].clone();let env = args[2].clone();
...
{let [val, var, ] = [
// (sexpr->ast exp env #f)
globals::sexpr_minus__g_ast.with(|value| value.get()).invoke(&[exp.clone(), env.clone(), Scm::False, ]), 
// (ensure-var! name env)
globals::ensure_minus_var_i.with(|value| value.get()).invoke(&[name.clone(), env.clone(), ]), ];{
// (variable-set-mutable! var)
globals::variable_minus_set_minus_mutable_i.with(|value| value.get()).invoke(&[var.clone(), ]);
// (make-assignment name var val)
globals::make_minus_assignment.with(|value| value.get()).invoke(&[name.clone(), var.clone(), val.clone(), ])}}}})}));
...
globals::definition_minus_variable.with(|value| value.get()).invoke(&[exp.clone(), ]), ];
// (let* ((value (definition-value exp)) (var (ensure-var! name env)) (val (sexpr->ast value env #f))) (make-assignment name var val))
{let [value, ] = [
// (definition-value exp)
globals::definition_minus_value.with(|value| value.get()).invoke(&[exp.clone(), ]), ];
...
globals::sexpr_minus__g_alternative.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 5{panic!("invalid arity")}let condition = args[0].clone();let consequent = args[1].clone();let alternative = args[2].clone();let env = args[3].clone();let tail_p = args[4].clone();
...
globals::sexpr_minus__g_ast.with(|value| value.get()).invoke(&[condition.clone(), env.clone(), Scm::False, ]), ];
// (let* ((a (sexpr->ast consequent env tail?)) (b (sexpr->ast alternative env tail?))) (make-alternative x a b))
{let [a, ] = [
// (sexpr->ast consequent env tail?)
globals::sexpr_minus__g_ast.with(|value| value.get()).invoke(&[consequent.clone(), env.clone(), tail_p.clone(), ]), ];
// (let* ((b (sexpr->ast alternative env tail?))) (make-alternative x a b))
{let [b, ] = [
// (sexpr->ast alternative env tail?)
globals::sexpr_minus__g_ast.with(|value| value.get()).invoke(&[alternative.clone(), env.clone(), tail_p.clone(), ]), ];
// (let* () (make-alternative x a b))

// (make-alternative x a b)
globals::make_minus_alternative.with(|value| value.get()).invoke(&[x.clone(), a.clone(), b.clone(), ])}}}}})}));
...
globals::sexpr_minus__g_application.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 4{panic!("invalid arity")}let func = args[0].clone();let arg_star_ = args[1].clone();let env = args[2].clone();let tail_p = args[3].clone();
...
if (
// (pair? func)
imports::pair_p.with(|value| value.get()).invoke(&[func.clone(), ])).is_true() {
// (eq? (car func) (quote lambda))
imports::eq_p.with(|value| value.get()).invoke(&[
// (car func)
imports::car.with(|value| value.get()).invoke(&[func.clone(), ]), Scm::symbol("lambda"), ])} else {Scm::False}).is_true() {
// (sexpr->fixlet (cadr func) (cddr func) arg* env tail?)
globals::sexpr_minus__g_fixlet.with(|value| value.get()).invoke(&[
// (cadr func)
imports::cadr.with(|value| value.get()).invoke(&[func.clone(), ]), 
// (cddr func)
imports::cddr.with(|value| value.get()).invoke(&[func.clone(), ]), arg_star_.clone(), env.clone(), tail_p.clone(), ])} else {
// (sexpr->regular-application func arg* env tail?)
globals::sexpr_minus__g_regular_minus_application.with(|value| value.get()).invoke(&[func.clone(), arg_star_.clone(), env.clone(), tail_p.clone(), ])}}})}));
...
globals::sexpr_minus__g_regular_minus_application.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 4{panic!("invalid arity")}let func = args[0].clone();let arg_star_ = args[1].clone();let env = args[2].clone();let tail_p = args[3].clone();
...
globals::sexpr_minus__g_ast.with(|value| value.get()).invoke(&[func.clone(), env.clone(), Scm::False, ]), ];
// (let ((args (sexpr->args arg* env))) (make-application func args tail?))
{let [args_, ] = [
// (sexpr->args arg* env)
globals::sexpr_minus__g_args.with(|value| value.get()).invoke(&[arg_star_.clone(), env.clone(), ]), ];
// (make-application func args tail?)
globals::make_minus_application.with(|value| value.get()).invoke(&[func.clone(), args_.clone(), tail_p.clone(), ])}}}})}));
...
globals::sexpr_minus__g_fixlet.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 5{panic!("invalid arity")}let param_star_ = args[0].clone();let body = args[1].clone();let arg_star_ = args[2].clone();let env = args[3].clone();let tail_p = args[4].clone();
...
globals::adjoin_minus_local_minus_env.with(|value| value.get()).invoke(&[param_star_.clone(), env.clone(), ]), ];
...
globals::sexpr_minus__g_sequence.with(|value| value.get()).invoke(&[body.clone(), local_minus_env.clone(), tail_p.clone(), ]), ];
// (let* () (make-fixlet param* func-body args))

// (make-fixlet param* func-body args)
globals::make_minus_fixlet.with(|value| value.get()).invoke(&[param_star_.clone(), func_minus_body.clone(), args_.clone(), ])}}}}})}));
// (define (sexpr->args arg* env) (if (null? arg*) (make-null-arg) (make-args (sexpr->ast (car arg*) env #f) (sexpr->args (cdr arg*) env))))
globals::sexpr_minus__g_args.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let arg_star_ = args[0].clone();let env = args[1].clone();
// (letrec () (if (null? arg*) (make-null-arg) (make-args (sexpr->ast (car arg*) env #f) (sexpr->args (cdr arg*) env))))
{if (
// (null? arg*)
imports::null_p.with(|value| value.get()).invoke(&[arg_star_.clone(), ])).is_true() {
// (make-null-arg)
globals::make_minus_null_minus_arg.with(|value| value.get()).invoke(&[])} else {
...
// (car arg*)
imports::car.with(|value| value.get()).invoke(&[arg_star_.clone(), ]), env.clone(), Scm::False, ]), 
// (sexpr->args (cdr arg*) env)
globals::sexpr_minus__g_args.with(|value| value.get()).invoke(&[
// (cdr arg*)
imports::cdr.with(|value| value.get()).invoke(&[arg_star_.clone(), ]), env.clone(), ]), ])}}})}));
...
globals::sexpr_minus__g_scope_minus_seq.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 4{panic!("invalid arity")}let bindings = args[0].clone();let body = args[1].clone();let env = args[2].clone();let tail_p = args[3].clone();
...
{if (
// (null? bindings)
imports::null_p.with(|value| value.get()).invoke(&[bindings.clone(), ])).is_true() {
// (sexpr->sequence body env tail?)
globals::sexpr_minus__g_sequence.with(|value| value.get()).invoke(&[body.clone(), env.clone(), tail_p.clone(), ])} else {
...
// (car bindings)
imports::car.with(|value| value.get()).invoke(&[bindings.clone(), ]), ]), 
// (list (cons (quote let*) (cons (cdr bindings) body)))
imports::list.with(|value| value.get()).invoke(&[
// (cons (quote let*) (cons (cdr bindings) body))
imports::cons.with(|value| value.get()).invoke(&[Scm::symbol("let*"), 
// (cons (cdr bindings) body)
imports::cons.with(|value| value.get()).invoke(&[
// (cdr bindings)
imports::cdr.with(|value| value.get()).invoke(&[bindings.clone(), ]), body.clone(), ]), ]), ]), env.clone(), tail_p.clone(), ])}}})}));
...
globals::sexpr_minus__g_scope_minus_rec.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 4{panic!("invalid arity")}let bindings = args[0].clone();let body = args[1].clone();let env = args[2].clone();let tail_p = args[3].clone();
...
imports::map.with(|value| value.get()).invoke(&[{Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let b = args[0].clone();
// (letrec () (car b))
{
// (car b)
imports::car.with(|value| value.get()).invoke(&[b.clone(), ])}})}, bindings.clone(), ]), ];
...
globals::adjoin_minus_boxed_minus_env.with(|value| value.get()).invoke(&[params.clone(), env.clone(), ]), ];
...
imports::map.with(|value| value.get()).invoke(&[{let body_minus_env = body_minus_env.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let b = args[0].clone();
// (letrec () (sexpr->ast (cadr b) body-env #f))
{
// (sexpr->ast (cadr b) body-env #f)
globals::sexpr_minus__g_ast.with(|value| value.get()).invoke(&[
// (cadr b)
imports::cadr.with(|value| value.get()).invoke(&[b.clone(), ]), body_minus_env.clone(), Scm::False, ])}})}, bindings.clone(), ]), ];
...
globals::sexpr_minus__g_sequence.with(|value| value.get()).invoke(&[body.clone(), body_minus_env.clone(), tail_p.clone(), ]), args_.clone(), ])}}}}})}));
...
globals::sexpr_minus__g_scope_minus_let.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 4{panic!("invalid arity")}let bindings = args[0].clone();let body = args[1].clone();let env = args[2].clone();let tail_p = args[3].clone();
...
{
// (cadr b)
imports::cadr.with(|value| value.get()).invoke(&[b.clone(), ])}})}, bindings.clone(), ]), ];
// (let* () (sexpr->fixlet param* body arg* env tail?))

// (sexpr->fixlet param* body arg* env tail?)
globals::sexpr_minus__g_fixlet.with(|value| value.get()).invoke(&[param_star_.clone(), body.clone(), arg_star_.clone(), env.clone(), tail_p.clone(), ])}}}})}));
...
globals::scan_minus_out_minus_defines.with(|value| value.get()).invoke(&[body.clone(), ]), ];if (
// (dotted-list? param*)
...
globals::make_minus_vararg_minus_abstraction.with(|value| value.get()).invoke(&[
...
{
// (lookup p local-env)
globals::lookup.with(|value| value.get()).invoke(&[p.clone(), local_minus_env.clone(), ])}})}, 
// (proper-list-part param*)
imports::proper_minus_list_minus_part.with(|value| value.get()).invoke(&[param_star_.clone(), ]), ]), 
...
globals::make_minus_abstraction.with(|value| value.get()).invoke(&[param_star_.clone(), 
// (map (lambda (p) (lookup p local-env)) param*)
imports::map.with(|value| value.get()).invoke(&[{let local_minus_env = local_minus_env.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let p = args[0].clone();
// (letrec () (lookup p local-env))
{
// (lookup p local-env)
globals::lookup.with(|value| value.get()).invoke(&[p.clone(), local_minus_env.clone(), ])}})}, param_star_.clone(), ]), 
// (sexpr->sequence body local-env #t)
...
globals::sexpr_minus__g_sequence.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let expr_star_ = args[0].clone();let env = args[1].clone();let tail_p = args[2].clone();
...
{{if (
// (null? expr*)
imports::null_p.with(|value| value.get()).invoke(&[expr_star_.clone(), ])).is_true() {
// (error "empty sequence")
imports::error.with(|value| value.get()).invoke(&[Scm::from("empty sequence"), ])} else {Scm::symbol("*UNSPECIFIED*")};if (
// (null? (cdr expr*))
imports::null_p.with(|value| value.get()).invoke(&[
// (cdr expr*)
imports::cdr.with(|value| value.get()).invoke(&[expr_star_.clone(), ]), ])).is_true() {
// (sexpr->ast (car expr*) env tail?)
globals::sexpr_minus__g_ast.with(|value| value.get()).invoke(&[
// (car expr*)
imports::car.with(|value| value.get()).invoke(&[expr_star_.clone(), ]), env.clone(), tail_p.clone(), ])} else {
// (let ((first (sexpr->ast (car expr*) env #f))) (make-sequence first (sexpr->sequence (cdr expr*) env tail?)))
{let [first, ] = [
// (sexpr->ast (car expr*) env #f)
globals::sexpr_minus__g_ast.with(|value| value.get()).invoke(&[
// (car expr*)
imports::car.with(|value| value.get()).invoke(&[expr_star_.clone(), ]), env.clone(), Scm::False, ]), ];
// (make-sequence first (sexpr->sequence (cdr expr*) env tail?))
globals::make_minus_sequence.with(|value| value.get()).invoke(&[first.clone(), 
// (sexpr->sequence (cdr expr*) env tail?)
globals::sexpr_minus__g_sequence.with(|value| value.get()).invoke(&[
// (cdr expr*)
imports::cdr.with(|value| value.get()).invoke(&[expr_star_.clone(), ]), env.clone(), tail_p.clone(), ]), ])}}}}})}));
...
globals::sexpr_minus__g_and.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let args_ = args[0].clone();let env = args[1].clone();let tail_p = args[2].clone();
...
// (make-constant #t)
globals::make_minus_constant.with(|value| value.get()).invoke(&[Scm::True, ])} else {if (
// (null? (cdr args))
imports::null_p.with(|value| value.get()).invoke(&[
// (cdr args)
imports::cdr.with(|value| value.get()).invoke(&[args_.clone(), ]), ])).is_true() {
// (sexpr->ast (car args) env tail?)
globals::sexpr_minus__g_ast.with(|value| value.get()).invoke(&[
// (car args)
imports::car.with(|value| value.get()).invoke(&[args_.clone(), ]), env.clone(), tail_p.clone(), ])} else {
...
globals::sexpr_minus__g_ast.with(|value| value.get()).invoke(&[
// (car args)
imports::car.with(|value| value.get()).invoke(&[args_.clone(), ]), env.clone(), Scm::False, ]), 
// (sexpr->and (cdr args) env tail?)
globals::sexpr_minus__g_and.with(|value| value.get()).invoke(&[
// (cdr args)
imports::cdr.with(|value| value.get()).invoke(&[args_.clone(), ]), env.clone(), tail_p.clone(), ]), 
// (make-constant #f)
globals::make_minus_constant.with(|value| value.get()).invoke(&[Scm::False, ]), ])}}}})}));
...
globals::sexpr_minus__g_import.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let stmt_star_ = args[0].clone();let env = args[1].clone();
...
if (
// (null? stmt*)
imports::null_p.with(|value| value.get()).invoke(&[stmt_star_.clone(), ])).is_true() {Scm::Nil} else {if (
// (eq? (quote only) (caar stmt*))
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("only"), 
// (caar stmt*)
imports::caar.with(|value| value.get()).invoke(&[stmt_star_.clone(), ]), ])).is_true() {
// (cons (import-only (cadar stmt*) (cddar stmt*) env) (sexpr->import (cdr stmt*) env))
imports::cons.with(|value| value.get()).invoke(&[
// (import-only (cadar stmt*) (cddar stmt*) env)
globals::import_minus_only.with(|value| value.get()).invoke(&[
// (cadar stmt*)
imports::cadar.with(|value| value.get()).invoke(&[stmt_star_.clone(), ]), 
// (cddar stmt*)
imports::cddar.with(|value| value.get()).invoke(&[stmt_star_.clone(), ]), env.clone(), ]), 
// (sexpr->import (cdr stmt*) env)
globals::sexpr_minus__g_import.with(|value| value.get()).invoke(&[
// (cdr stmt*)
imports::cdr.with(|value| value.get()).invoke(&[stmt_star_.clone(), ]), env.clone(), ]), ])} else {
...
globals::sexpr_minus__g_export.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let export_minus_spec_star_ = args[0].clone();let env = args[1].clone();
...
if (
// (null? export-spec*)
imports::null_p.with(|value| value.get()).invoke(&[export_minus_spec_star_.clone(), ])).is_true() {Scm::Nil} else {
...
globals::make_minus_export.with(|value| value.get()).invoke(&[env.clone(), 
// (car export-spec*)
imports::car.with(|value| value.get()).invoke(&[export_minus_spec_star_.clone(), ]), 
// (car export-spec*)
imports::car.with(|value| value.get()).invoke(&[export_minus_spec_star_.clone(), ]), ]), 
// (sexpr->export (cdr export-spec*) env)
globals::sexpr_minus__g_export.with(|value| value.get()).invoke(&[
// (cdr export-spec*)
imports::cdr.with(|value| value.get()).invoke(&[export_minus_spec_star_.clone(), ]), env.clone(), ]), ])}}})}));
// (define (import-all lib env) (adjoin-import*! (library-exports (library-decls (get-lib lib))) env) (make-import lib))
globals::import_minus_all.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let lib = args[0].clone();let env = args[1].clone();
...
globals::adjoin_minus_import_star__i.with(|value| value.get()).invoke(&[
// (library-exports (library-decls (get-lib lib)))
globals::library_minus_exports.with(|value| value.get()).invoke(&[
// (library-decls (get-lib lib))
globals::library_minus_decls.with(|value| value.get()).invoke(&[
// (get-lib lib)
globals::get_minus_lib.with(|value| value.get()).invoke(&[lib.clone(), ]), ]), ]), env.clone(), ]);
// (make-import lib)
...
globals::import_minus_only.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let lib = args[0].clone();let names = args[1].clone();let env = args[2].clone();
...
globals::check_minus_imports.with(|value| value.get()).invoke(&[names.clone(), 
// (library-exports (library-decls (get-lib lib)))
globals::library_minus_exports.with(|value| value.get()).invoke(&[
// (library-decls (get-lib lib))
globals::library_minus_decls.with(|value| value.get()).invoke(&[
// (get-lib lib)
globals::get_minus_lib.with(|value| value.get()).invoke(&[lib.clone(), ]), ]), ]), lib.clone(), ]);
// (adjoin-import*! names env)
globals::adjoin_minus_import_star__i.with(|value| value.get()).invoke(&[names.clone(), env.clone(), ]);
// (make-import-only lib names)
globals::make_minus_import_minus_only.with(|value| value.get()).invoke(&[lib.clone(), names.clone(), ])}}})}));
// (define (get-lib lib) (let ((full-path (find-library (quote ("." "./lib" "scm-libs" "../scheme/lib" "../scm-libs" "../../scm-libs")) (library-path lib) (quote (".sld" ".slx"))))) (if full-path (read (open-input-file full-path)) (error "Unknown library" lib))))
globals::get_minus_lib.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let lib = args[0].clone();
// (letrec () (let ((full-path (find-library (quote ("." "./lib" "scm-libs" "../scheme/lib" "../scm-libs" "../../scm-libs")) (library-path lib) (quote (".sld" ".slx"))))) (if full-path (read (open-input-file full-path)) (error "Unknown library" lib))))
{
// (let ((full-path (find-library (quote ("." "./lib" "scm-libs" "../scheme/lib" "../scm-libs" "../../scm-libs")) (library-path lib) (quote (".sld" ".slx"))))) (if full-path (read (open-input-file full-path)) (error "Unknown library" lib)))
{let [full_minus_path, ] = [
// (find-library (quote ("." "./lib" "scm-libs" "../scheme/lib" "../scm-libs" "../../scm-libs")) (library-path lib) (quote (".sld" ".slx")))
globals::find_minus_library.with(|value| value.get()).invoke(&[Scm::pair(Scm::from("."), Scm::pair(Scm::from("./lib"), Scm::pair(Scm::from("scm-libs"), Scm::pair(Scm::from("../scheme/lib"), Scm::pair(Scm::from("../scm-libs"), Scm::pair(Scm::from("../../scm-libs"), Scm::Nil)))))), 
// (library-path lib)
globals::library_minus_path.with(|value| value.get()).invoke(&[lib.clone(), ]), Scm::pair(Scm::from(".sld"), Scm::pair(Scm::from(".slx"), Scm::Nil)), ]), ];if (full_minus_path.clone()).is_true() {
// (read (open-input-file full-path))
imports::read.with(|value| value.get()).invoke(&[
// (open-input-file full-path)
imports::open_minus_input_minus_file.with(|value| value.get()).invoke(&[full_minus_path.clone(), ]), ])} else {
// (error "Unknown library" lib)
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown library"), lib.clone(), ])}}}})}));
...
globals::find_minus_library.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let base_minus_path_star_ = args[0].clone();let relative_minus_path = args[1].clone();let extension_star_ = args[2].clone();
...
{if (
// (null? base-path*)
imports::null_p.with(|value| value.get()).invoke(&[base_minus_path_star_.clone(), ])).is_true() {Scm::False} else {
...
// (car base-path*)
imports::car.with(|value| value.get()).invoke(&[base_minus_path_star_.clone(), ]), relative_minus_path.clone(), ]), ];
...
globals::find_minus_library_minus_ext.with(|value| value.get()).invoke(&[path.clone(), extension_star_.clone(), ]), ];
// (let* () (if full-path full-path (find-library (cdr base-path*) relative-path extension*)))
if (full_minus_path.clone()).is_true() {full_minus_path.clone()} else {
// (find-library (cdr base-path*) relative-path extension*)
globals::find_minus_library.with(|value| value.get()).invoke(&[
// (cdr base-path*)
imports::cdr.with(|value| value.get()).invoke(&[base_minus_path_star_.clone(), ]), relative_minus_path.clone(), extension_star_.clone(), ])}}}}}})}));
...
globals::find_minus_library_minus_ext.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let path = args[0].clone();let extension_star_ = args[1].clone();
...
{if (
// (null? extension*)
imports::null_p.with(|value| value.get()).invoke(&[extension_star_.clone(), ])).is_true() {Scm::False} else {
...
imports::string_minus_append.with(|value| value.get()).invoke(&[path.clone(), 
// (car extension*)
imports::car.with(|value| value.get()).invoke(&[extension_star_.clone(), ]), ]), ];if (
// (file-exists? full-path)
imports::file_minus_exists_p.with(|value| value.get()).invoke(&[full_minus_path.clone(), ])).is_true() {full_minus_path.clone()} else {
// (find-library-ext path (cdr extension*))
globals::find_minus_library_minus_ext.with(|value| value.get()).invoke(&[path.clone(), 
// (cdr extension*)
imports::cdr.with(|value| value.get()).invoke(&[extension_star_.clone(), ]), ])}}}}})}));
// (define (library-path lib) (reduce (lambda (left right) (string-append left (string-append "/" right))) "" (map symbol->string lib)))
globals::library_minus_path.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let lib = args[0].clone();
...
globals::reduce.with(|value| value.get()).invoke(&[{Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let left = args[0].clone();let right = args[1].clone();
// (letrec () (string-append left (string-append "/" right)))
{
// (string-append left (string-append "/" right))
imports::string_minus_append.with(|value| value.get()).invoke(&[left.clone(), 
// (string-append "/" right)
imports::string_minus_append.with(|value| value.get()).invoke(&[Scm::from("/"), right.clone(), ]), ])}})}, Scm::from(""), 
// (map symbol->string lib)
imports::map.with(|value| value.get()).invoke(&[imports::symbol_minus__g_string.with(|value| value.get()), lib.clone(), ]), ])}})}));
...
globals::check_minus_imports.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let imports = args[0].clone();let exports = args[1].clone();let lib = args[2].clone();
...
{if (
// (null? imports)
imports::null_p.with(|value| value.get()).invoke(&[imports.clone(), ])).is_true() {Scm::True} else {if (
// (memq (car imports) exports)
imports::memq.with(|value| value.get()).invoke(&[
// (car imports)
imports::car.with(|value| value.get()).invoke(&[imports.clone(), ]), exports.clone(), ])).is_true() {
// (check-imports (cdr imports) exports lib)
globals::check_minus_imports.with(|value| value.get()).invoke(&[
// (cdr imports)
imports::cdr.with(|value| value.get()).invoke(&[imports.clone(), ]), exports.clone(), lib.clone(), ])} else {
// (error "Invalid import" (car imports) lib)
imports::error.with(|value| value.get()).invoke(&[Scm::from("Invalid import"), 
// (car imports)
imports::car.with(|value| value.get()).invoke(&[imports.clone(), ]), lib.clone(), ])}}}})}));
// (define (library? exp*) (and (pair? exp*) (eq? (quote define-library) (car exp*))))
globals::library_p.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let exp_star_ = args[0].clone();
// (letrec () (and (pair? exp*) (eq? (quote define-library) (car exp*))))
{
// (and (pair? exp*) (eq? (quote define-library) (car exp*)))
if (
// (pair? exp*)
imports::pair_p.with(|value| value.get()).invoke(&[exp_star_.clone(), ])).is_true() {
// (eq? (quote define-library) (car exp*))
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("define-library"), 
// (car exp*)
imports::car.with(|value| value.get()).invoke(&[exp_star_.clone(), ]), ])} else {Scm::False}}})}));
// (define (definition? expr) (and (pair? expr) (eq? (car expr) (quote define))))
globals::definition_p.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let expr = args[0].clone();
// (letrec () (and (pair? expr) (eq? (car expr) (quote define))))
{
// (and (pair? expr) (eq? (car expr) (quote define)))
if (
// (pair? expr)
imports::pair_p.with(|value| value.get()).invoke(&[expr.clone(), ])).is_true() {
// (eq? (car expr) (quote define))
imports::eq_p.with(|value| value.get()).invoke(&[
// (car expr)
imports::car.with(|value| value.get()).invoke(&[expr.clone(), ]), Scm::symbol("define"), ])} else {Scm::False}}})}));
// (define (definition-variable expr) (if (pair? (cadr expr)) (caadr expr) (cadr expr)))
globals::definition_minus_variable.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let expr = args[0].clone();
// (letrec () (if (pair? (cadr expr)) (caadr expr) (cadr expr)))
{if (
// (pair? (cadr expr))
imports::pair_p.with(|value| value.get()).invoke(&[
// (cadr expr)
imports::cadr.with(|value| value.get()).invoke(&[expr.clone(), ]), ])).is_true() {
// (caadr expr)
imports::caadr.with(|value| value.get()).invoke(&[expr.clone(), ])} else {
// (cadr expr)
imports::cadr.with(|value| value.get()).invoke(&[expr.clone(), ])}}})}));
// (define (definition-value expr) (if (pair? (cadr expr)) (cons (quote lambda) (cons (cdadr expr) (cddr expr))) (caddr expr)))
globals::definition_minus_value.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let expr = args[0].clone();
...
imports::cons.with(|value| value.get()).invoke(&[Scm::symbol("lambda"), 
// (cons (cdadr expr) (cddr expr))
imports::cons.with(|value| value.get()).invoke(&[
// (cdadr expr)
imports::cdadr.with(|value| value.get()).invoke(&[expr.clone(), ]), 
// (cddr expr)
imports::cddr.with(|value| value.get()).invoke(&[expr.clone(), ]), ]), ])} else {
// (caddr expr)
imports::caddr.with(|value| value.get()).invoke(&[expr.clone(), ])}}})}));
// (define (if-condition expr) (cadr expr))
globals::if_minus_condition.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let expr = args[0].clone();
// (letrec () (cadr expr))
{
// (cadr expr)
imports::cadr.with(|value| value.get()).invoke(&[expr.clone(), ])}})}));
// (define (if-consequence expr) (caddr expr))
globals::if_minus_consequence.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let expr = args[0].clone();
// (letrec () (caddr expr))
{
// (caddr expr)
imports::caddr.with(|value| value.get()).invoke(&[expr.clone(), ])}})}));
// (define (if-alternative expr) (if (pair? (cdddr expr)) (cadddr expr) (quote (quote *UNSPECIFIED*))))
globals::if_minus_alternative.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let expr = args[0].clone();
// (letrec () (if (pair? (cdddr expr)) (cadddr expr) (quote (quote *UNSPECIFIED*))))
{if (
// (pair? (cdddr expr))
imports::pair_p.with(|value| value.get()).invoke(&[
// (cdddr expr)
imports::cdddr.with(|value| value.get()).invoke(&[expr.clone(), ]), ])).is_true() {
// (cadddr expr)
imports::cadddr.with(|value| value.get()).invoke(&[expr.clone(), ])} else {Scm::pair(Scm::symbol("quote"), Scm::pair(Scm::symbol("*UNSPECIFIED*"), Scm::Nil))}}})}));
// (define (cond-clauses expr) (cdr expr))
globals::cond_minus_clauses.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let expr = args[0].clone();
// (letrec () (cdr expr))
{
// (cdr expr)
imports::cdr.with(|value| value.get()).invoke(&[expr.clone(), ])}})}));
// (define (cond-clause-condition clause) (car clause))
globals::cond_minus_clause_minus_condition.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let clause = args[0].clone();
// (letrec () (car clause))
{
// (car clause)
imports::car.with(|value| value.get()).invoke(&[clause.clone(), ])}})}));
// (define (cond-clause-sequence clause) (cdr clause))
globals::cond_minus_clause_minus_sequence.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let clause = args[0].clone();
// (letrec () (cdr clause))
{
// (cdr clause)
imports::cdr.with(|value| value.get()).invoke(&[clause.clone(), ])}})}));
// (define (import? expr) (and (pair? expr) (eq? (car expr) (quote import))))
globals::import_p.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let expr = args[0].clone();
...
imports::eq_p.with(|value| value.get()).invoke(&[
// (car expr)
imports::car.with(|value| value.get()).invoke(&[expr.clone(), ]), Scm::symbol("import"), ])} else {Scm::False}}})}));
// (define (import-libnames exp*) (map importset-libname (cdr exp*)))
globals::import_minus_libnames.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let exp_star_ = args[0].clone();
// (letrec () (map importset-libname (cdr exp*)))
{
// (map importset-libname (cdr exp*))
imports::map.with(|value| value.get()).invoke(&[globals::importset_minus_libname.with(|value| value.get()), 
// (cdr exp*)
imports::cdr.with(|value| value.get()).invoke(&[exp_star_.clone(), ]), ])}})}));
...
globals::importset_minus_libname.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let expr = args[0].clone();
...
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("only"), 
// (car expr)
imports::car.with(|value| value.get()).invoke(&[expr.clone(), ]), ])).is_true() {
// (importset-libname (cadr expr))
globals::importset_minus_libname.with(|value| value.get()).invoke(&[
// (cadr expr)
imports::cadr.with(|value| value.get()).invoke(&[expr.clone(), ]), ])} else {if (
// (eq? (quote except) (car expr))
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("except"), 
// (car expr)
imports::car.with(|value| value.get()).invoke(&[expr.clone(), ]), ])).is_true() {
// (importset-libname (cadr expr))
globals::importset_minus_libname.with(|value| value.get()).invoke(&[
// (cadr expr)
imports::cadr.with(|value| value.get()).invoke(&[expr.clone(), ]), ])} else {expr.clone()}}}})}));
// (define (library-name expr) (cadr expr))
globals::library_minus_name.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let expr = args[0].clone();
// (letrec () (cadr expr))
{
// (cadr expr)
imports::cadr.with(|value| value.get()).invoke(&[expr.clone(), ])}})}));
// (define (library-decls expr) (cddr expr))
globals::library_minus_decls.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let expr = args[0].clone();
// (letrec () (cddr expr))
{
// (cddr expr)
imports::cddr.with(|value| value.get()).invoke(&[expr.clone(), ])}})}));
...
globals::library_minus_exports.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let lib_minus_decl_star_ = args[0].clone();
...
if (
// (null? lib-decl*)
imports::null_p.with(|value| value.get()).invoke(&[lib_minus_decl_star_.clone(), ])).is_true() {Scm::Nil} else {if (
// (eq? (quote export) (caar lib-decl*))
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("export"), 
// (caar lib-decl*)
imports::caar.with(|value| value.get()).invoke(&[lib_minus_decl_star_.clone(), ]), ])).is_true() {
// (append (cdar lib-decl*) (library-exports (cdr lib-decl*)))
globals::append.with(|value| value.get()).invoke(&[
// (cdar lib-decl*)
imports::cdar.with(|value| value.get()).invoke(&[lib_minus_decl_star_.clone(), ]), 
// (library-exports (cdr lib-decl*))
globals::library_minus_exports.with(|value| value.get()).invoke(&[
// (cdr lib-decl*)
imports::cdr.with(|value| value.get()).invoke(&[lib_minus_decl_star_.clone(), ]), ]), ])} else {
// (library-exports (cdr lib-decl*))
globals::library_minus_exports.with(|value| value.get()).invoke(&[
// (cdr lib-decl*)
imports::cdr.with(|value| value.get()).invoke(&[lib_minus_decl_star_.clone(), ]), ])}}}})}));
...
gen_minus_rust.set({let comment = comment.clone();let node = node.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
...
globals::showln.with(|value| value.get()).invoke(&[module.clone(), comment.clone(), ]);
// (node (quote gen-rust) module)
node.clone().invoke(&[Scm::symbol("gen-rust"), module.clone(), ])}}})});
...
// (make-set)
globals::make_minus_set.with(|value| value.get()).invoke(&[])}})});
gen_minus_rust.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
// (letrec () (print module "(/*NOP*/)"))
{
// (print module "(/*NOP*/)")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("(/*NOP*/)"), ])}})});
self_.set({let transform = transform.clone();let free_minus_vars = free_minus_vars.clone();let gen_minus_rust = gen_minus_rust.clone();Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let msg = args[0].clone();let args_ = Scm::list(&args[1..]);
...
// (make-set)
globals::make_minus_set.with(|value| value.get()).invoke(&[])}})});
gen_minus_constant.set({let gen_minus_constant = gen_minus_constant.clone();Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let module = args[0].clone();let val = args[1].clone();
...
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("Scm::Nil"), ])} else {if (
// (eq? val #t)
imports::eq_p.with(|value| value.get()).invoke(&[val.clone(), Scm::True, ])).is_true() {
// (print module "Scm::True")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("Scm::True"), ])} else {if (
// (eq? val #f)
imports::eq_p.with(|value| value.get()).invoke(&[val.clone(), Scm::False, ])).is_true() {
// (print module "Scm::False")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("Scm::False"), ])} else {if (
// (symbol? val)
imports::symbol_p.with(|value| value.get()).invoke(&[val.clone(), ])).is_true() {
// (print module "Scm::symbol(\"" val "\")")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("Scm::symbol(\""), val.clone(), Scm::from("\")"), ])} else {if (
// (char? val)
imports::char_p.with(|value| value.get()).invoke(&[val.clone(), ])).is_true() {
// (print module "Scm::char('" val "')")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("Scm::char('"), val.clone(), Scm::from("')"), ])} else {if (
// (pair? val)
imports::pair_p.with(|value| value.get()).invoke(&[val.clone(), ])).is_true() {{
// (print module "Scm::pair(")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("Scm::pair("), ]);
...
// (print module ")")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from(")"), ])}} else {{
// (print module "Scm::from(")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("Scm::from("), ]);
// (show module val)
globals::show.with(|value| value.get()).invoke(&[module.clone(), val.clone(), ]);
// (print module ")")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from(")"), ])}}}}}}}}})});
gen_minus_rust.set({let gen_minus_constant = gen_minus_constant.clone();let val = val.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
// (letrec () (gen-constant module val))
{
// (gen-constant module val)
gen_minus_constant.get().invoke(&[module.clone(), val.clone(), ])}})});
self_.set({let transform = transform.clone();let free_minus_vars = free_minus_vars.clone();let gen_minus_rust = gen_minus_rust.clone();Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let msg = args[0].clone();let args_ = Scm::list(&args[1..]);
...
gen_minus_rust.set({let name = name.clone();let var = var.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
...
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("globals::"), 
...
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("imports::"), 
// (rustify-identifier name)
globals::rustify_minus_identifier.with(|value| value.get()).invoke(&[name.clone(), ]), Scm::from(".with(|value| value.get())"), ])} else {if (
...
gen_minus_rust.set({let name = name.clone();let val = val.clone();let var = var.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
...
// (print module "))")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("))"), ])}} else {if (
...
gen_minus_rust.set({let condition = condition.clone();let consequent = consequent.clone();let alternative = alternative.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
...
{{
// (print module "if (")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("if ("), ]);
// (condition (quote gen-rust) module)
condition.clone().invoke(&[Scm::symbol("gen-rust"), module.clone(), ]);
// (print module ").is_true() {")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from(").is_true() {"), ]);
...
gen_minus_rust.set({let func = func.clone();let args_ = args_.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
...
// (print module ".invoke(&[")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from(".invoke(&["), ]);
...
let gen_minus_rust = Scm::uninitialized().into_boxed();
let self_ = Scm::uninitialized().into_boxed();
repr.set({let arg = arg.clone();let next = next.clone();Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}
// (letrec () (cons (quote ARG) (cons arg next)))
{
// (cons (quote ARG) (cons arg next))
imports::cons.with(|value| value.get()).invoke(&[Scm::symbol("ARG"), 
// (cons arg next)
imports::cons.with(|value| value.get()).invoke(&[arg.clone(), next.clone(), ]), ])}})});
transform.set({let self_ = self_.clone();let arg = arg.clone();let next = next.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let fnc = args[0].clone();
...
next.clone().invoke(&[Scm::symbol("transform"), fnc.clone(), ]), ])}})}, ])}})});
free_minus_vars.set({let arg = arg.clone();let next = next.clone();Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}
...
gen_minus_rust.set({let arg = arg.clone();let next = next.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
// (letrec () (arg (quote gen-rust) module) (print module ", ") (next (quote gen-rust) module))
{{
// (arg (quote gen-rust) module)
arg.clone().invoke(&[Scm::symbol("gen-rust"), module.clone(), ]);
// (print module ", ")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from(", "), ]);
// (next (quote gen-rust) module)
next.clone().invoke(&[Scm::symbol("gen-rust"), module.clone(), ])}}})});
self_.set({let transform = transform.clone();let free_minus_vars = free_minus_vars.clone();let gen_minus_rust = gen_minus_rust.clone();Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let msg = args[0].clone();let args_ = Scm::list(&args[1..]);
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("Unknown message ARG"), msg.clone(), ])}}}}}}})});
self_.get()}})}));
...
gen_minus_params.set({let module = module.clone();let gen_minus_params = gen_minus_params.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let p_star_ = args[0].clone();
...
globals::rust_minus_block.with(|value| value.get()).invoke(&[module.clone(), {let module = module.clone();let gen_minus_params = gen_minus_params.clone();let params = params.clone();let args_ = args_.clone();let body = body.clone();Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}
...
// (next (quote free-vars))
next.clone().invoke(&[Scm::symbol("free-vars"), ]), ])}})});
gen_minus_rust_minus_inner.set({let first = first.clone();let next = next.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
...
// (next (quote gen-rust) module)
next.clone().invoke(&[Scm::symbol("gen-rust"), module.clone(), ])}}}})});
gen_minus_rust.set({let gen_minus_rust_minus_inner = gen_minus_rust_minus_inner.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
...
// (letrec () (println module "#[allow(unused_imports)] use sunny_core::{Mut, Scm};") (print module "mod imports") (rust-block module (lambda () (for-each (lambda (i) (i (quote gen-rust) module)) imports))) (println module) (println module) (print module "pub mod exports") (rust-block module (lambda () (gen-exports module exports))) (println module) (println module) (print module "mod globals") (rust-block module (lambda () (if (any (lambda (g) (global-regular? (cdr g))) globals) (println module "use sunny_core::{Mut, Scm};")) (rust-gen-global-defs module globals))) (println module) (println module) (if (eq? (quote NOP) (body (quote kind))) (println module "pub fn initialize() {") (begin (println module "thread_local! { static INITIALIZED: std::cell::Cell<bool> = std::cell::Cell::new(false); }") (println module) (println module "pub fn initialize() {") (println module "if INITIALIZED.with(|x| x.get()) { return }") (println module "INITIALIZED.with(|x| x.set(true));") (println module))) (for-each (lambda (lib) (print module "crate::") (for-each (lambda (l) (print module (rustify-libname l) "::")) lib) (println module "initialize();")) init) (body (quote gen-rust) module) (println module ";}"))
{{
...
// (body (quote free-vars))
body.clone().invoke(&[Scm::symbol("free-vars"), ])}})});
gen_minus_rust.set({let name = name.clone();let body = body.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
...
globals::rust_minus_block.with(|value| value.get()).invoke(&[module.clone(), {let module = module.clone();let name = name.clone();let body = body.clone();Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}
...
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from(".into_boxed();"), ]);
// (body (quote gen-rust) module)
body.clone().invoke(&[Scm::symbol("gen-rust"), module.clone(), ])}}})}, ])}})});
self_.set({let transform = transform.clone();let free_minus_vars = free_minus_vars.clone();let gen_minus_rust = gen_minus_rust.clone();Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let msg = args[0].clone();let args_ = Scm::list(&args[1..]);
...
// (letrec () self)
{self_.get()}})}, ])}})});
gen_minus_rust.set({let name = name.clone();let env = env.clone();let exname = exname.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
...
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("pub use super::"), ]);
...
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("globals::"), ])} else {if (
// (eq? (quote IMPORT-REF) (variable-getter var))
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("IMPORT-REF"), 
// (variable-getter var)
globals::variable_minus_getter.with(|value| value.get()).invoke(&[var.clone(), ]), ])).is_true() {
// (print module "imports::")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("imports::"), ])} else {
...
// (make-set)
globals::make_minus_set.with(|value| value.get()).invoke(&[])}})});
gen_minus_libname.set({let gen_minus_libname = gen_minus_libname.clone();Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let module = args[0].clone();let lib = args[1].clone();
...
gen_minus_rust.set({let gen_minus_libname = gen_minus_libname.clone();let lib = lib.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
// (letrec () (print module "pub use crate::") (gen-libname module lib) (print module "::exports::*;") (println module))
{{
// (print module "pub use crate::")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("pub use crate::"), ]);
// (gen-libname module lib)
gen_minus_libname.get().invoke(&[module.clone(), lib.clone(), ]);
// (print module "::exports::*;")
globals::print.with(|value| value.get()).invoke(&[module.clone(), Scm::from("::exports::*;"), ]);
// (println module)
globals::println.with(|value| value.get()).invoke(&[module.clone(), ])}}})});
self_.set({let transform = transform.clone();let free_minus_vars = free_minus_vars.clone();let gen_minus_rust = gen_minus_rust.clone();Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let msg = args[0].clone();let args_ = Scm::list(&args[1..]);
...
// (cdr lib)
imports::cdr.with(|value| value.get()).invoke(&[lib.clone(), ]), ])}}}})});
gen_minus_imports.set({let gen_minus_imports = gen_minus_imports.clone();Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let module = args[0].clone();let names = args[1].clone();
...
gen_minus_rust.set({let gen_minus_libname = gen_minus_libname.clone();let lib = lib.clone();let gen_minus_imports = gen_minus_imports.clone();let names = names.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
...
globals::print_minus_list.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let seq = args[0].clone();
// (letrec () (if (pair? seq) (cons ((car seq) (quote repr)) (print-list (cdr seq))) (quote ())))
{if (
// (pair? seq)
imports::pair_p.with(|value| value.get()).invoke(&[seq.clone(), ])).is_true() {
// (cons ((car seq) (quote repr)) (print-list (cdr seq)))
imports::cons.with(|value| value.get()).invoke(&[
// ((car seq) (quote repr))

// (car seq)
imports::car.with(|value| value.get()).invoke(&[seq.clone(), ]).invoke(&[Scm::symbol("repr"), ]), 
// (print-list (cdr seq))
globals::print_minus_list.with(|value| value.get()).invoke(&[
// (cdr seq)
imports::cdr.with(|value| value.get()).invoke(&[seq.clone(), ]), ]), ])} else {Scm::Nil}}})}));
// (define (transform-list seq func) (if (pair? seq) (cons ((car seq) (quote transform) func) (transform-list (cdr seq) func)) (quote ())))
globals::transform_minus_list.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let seq = args[0].clone();let func = args[1].clone();
...
// (car seq)
imports::car.with(|value| value.get()).invoke(&[seq.clone(), ]).invoke(&[Scm::symbol("transform"), func.clone(), ]), 
// (transform-list (cdr seq) func)
globals::transform_minus_list.with(|value| value.get()).invoke(&[
// (cdr seq)
imports::cdr.with(|value| value.get()).invoke(&[seq.clone(), ]), func.clone(), ]), ])} else {Scm::Nil}}})}));
...
globals::list_minus_find_minus_free_minus_vars.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let seq = args[0].clone();let local_minus_env = args[1].clone();
...
// (car seq)
imports::car.with(|value| value.get()).invoke(&[seq.clone(), ]).invoke(&[Scm::symbol("free-vars"), local_minus_env.clone(), ]), 
// (list-find-free-vars (cdr seq) local-env)
globals::list_minus_find_minus_free_minus_vars.with(|value| value.get()).invoke(&[
// (cdr seq)
imports::cdr.with(|value| value.get()).invoke(&[seq.clone(), ]), local_minus_env.clone(), ]), ])} else {Scm::Nil}}})}));
...
globals::rust_minus_gen_minus_modules.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let module = args[0].clone();let libs = args[1].clone();
...
globals::rust_minus_gen_minus_module_minus_tree_minus_list.with(|value| value.get()).invoke(&[module.clone(), 
...
globals::rust_minus_gen_minus_module_minus_tree_minus_list.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let module = args[0].clone();let nodes = args[1].clone();
...
imports::for_minus_each.with(|value| value.get()).invoke(&[{let module = module.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let child = args[0].clone();
// (letrec () (rust-gen-module-tree module child))
{
// (rust-gen-module-tree module child)
globals::rust_minus_gen_minus_module_minus_tree.with(|value| value.get()).invoke(&[module.clone(), child.clone(), ])}})}, nodes.clone(), ])}})}));
// (define (rust-gen-in-module name base-path body) (let ((module (open-module name base-path))) (body module) (close-module module)))
globals::rust_minus_gen_minus_in_minus_module.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let name = args[0].clone();let base_minus_path = args[1].clone();let body = args[2].clone();
...
globals::open_minus_module.with(|value| value.get()).invoke(&[name.clone(), base_minus_path.clone(), ]), ];{
// (body module)
body.clone().invoke(&[module.clone(), ]);
// (close-module module)
globals::close_minus_module.with(|value| value.get()).invoke(&[module.clone(), ])}}}})}));
// (define (rust-gen-in-submodule name parent body) (let ((module (open-submodule name parent))) (body module) (close-module module)))
globals::rust_minus_gen_minus_in_minus_submodule.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let name = args[0].clone();let parent = args[1].clone();let body = args[2].clone();
...
globals::open_minus_submodule.with(|value| value.get()).invoke(&[name.clone(), parent.clone(), ]), ];{
// (body module)
body.clone().invoke(&[module.clone(), ]);
// (close-module module)
globals::close_minus_module.with(|value| value.get()).invoke(&[module.clone(), ])}}}})}));
...
globals::open_minus_module.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name = args[0].clone();let base_minus_path = args[1].clone();
...
imports::string_minus_append.with(|value| value.get()).invoke(&[base_minus_path.clone(), Scm::from("/"), 
// (rustify-libname name)
globals::rustify_minus_libname.with(|value| value.get()).invoke(&[name.clone(), ]), ]), ];{
...
imports::list.with(|value| value.get()).invoke(&[Scm::symbol("module"), 
// (open-output-file (string-append path "/mod.rs"))
imports::open_minus_output_minus_file.with(|value| value.get()).invoke(&[
// (string-append path "/mod.rs")
imports::string_minus_append.with(|value| value.get()).invoke(&[path.clone(), Scm::from("/mod.rs"), ]), ]), path.clone(), ])}}}})}));
// (define (open-submodule name module) (open-module name (module-path module)))
globals::open_minus_submodule.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name = args[0].clone();let module = args[1].clone();
// (letrec () (open-module name (module-path module)))
{
// (open-module name (module-path module))
globals::open_minus_module.with(|value| value.get()).invoke(&[name.clone(), 
// (module-path module)
globals::module_minus_path.with(|value| value.get()).invoke(&[module.clone(), ]), ])}})}));
// (define (module? obj) (and (pair? obj) (eq? (quote module) (car obj))))
globals::module_p.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let obj = args[0].clone();
// (letrec () (and (pair? obj) (eq? (quote module) (car obj))))
{
// (and (pair? obj) (eq? (quote module) (car obj)))
if (
// (pair? obj)
imports::pair_p.with(|value| value.get()).invoke(&[obj.clone(), ])).is_true() {
// (eq? (quote module) (car obj))
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("module"), 
// (car obj)
imports::car.with(|value| value.get()).invoke(&[obj.clone(), ]), ])} else {Scm::False}}})}));
// (define (close-module module) (close-port (module-port module)))
globals::close_minus_module.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
// (letrec () (close-port (module-port module)))
{
// (close-port (module-port module))
imports::close_minus_port.with(|value| value.get()).invoke(&[
// (module-port module)
globals::module_minus_port.with(|value| value.get()).invoke(&[module.clone(), ]), ])}})}));
// (define (module-port module) (cadr module))
globals::module_minus_port.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
// (letrec () (cadr module))
{
// (cadr module)
imports::cadr.with(|value| value.get()).invoke(&[module.clone(), ])}})}));
// (define (module-path module) (caddr module))
globals::module_minus_path.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let module = args[0].clone();
// (letrec () (caddr module))
{
// (caddr module)
imports::caddr.with(|value| value.get()).invoke(&[module.clone(), ])}})}));
// (define (make-module-tree-node name) (cons name (quote ())))
globals::make_minus_module_minus_tree_minus_node.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let name = args[0].clone();
// (letrec () (cons name (quote ())))
{
// (cons name (quote ()))
imports::cons.with(|value| value.get()).invoke(&[name.clone(), Scm::Nil, ])}})}));
// (define (make-module-tree-leaf name lib) (cons name lib))
globals::make_minus_module_minus_tree_minus_leaf.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name = args[0].clone();let lib = args[1].clone();
// (letrec () (cons name lib))
{
// (cons name lib)
imports::cons.with(|value| value.get()).invoke(&[name.clone(), lib.clone(), ])}})}));
// (define (module-tree-leaf? node) (and (pair? node) (symbol? (car node)) (not (null? (cdr node))) (not (pair? (cdr node)))))
globals::module_minus_tree_minus_leaf_p.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let node = args[0].clone();
...
if (
// (pair? node)
imports::pair_p.with(|value| value.get()).invoke(&[node.clone(), ])).is_true() {if (
// (symbol? (car node))
imports::symbol_p.with(|value| value.get()).invoke(&[
// (car node)
imports::car.with(|value| value.get()).invoke(&[node.clone(), ]), ])).is_true() {if (
// (not (null? (cdr node)))
imports::not.with(|value| value.get()).invoke(&[
// (null? (cdr node))
imports::null_p.with(|value| value.get()).invoke(&[
// (cdr node)
imports::cdr.with(|value| value.get()).invoke(&[node.clone(), ]), ]), ])).is_true() {
// (not (pair? (cdr node)))
imports::not.with(|value| value.get()).invoke(&[
// (pair? (cdr node))
imports::pair_p.with(|value| value.get()).invoke(&[
// (cdr node)
imports::cdr.with(|value| value.get()).invoke(&[node.clone(), ]), ]), ])} else {Scm::False}} else {Scm::False}} else {Scm::False}}})}));
// (define (module-tree-name node) (car node))
globals::module_minus_tree_minus_name.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let node = args[0].clone();
// (letrec () (car node))
{
// (car node)
imports::car.with(|value| value.get()).invoke(&[node.clone(), ])}})}));
// (define (module-tree-children node) (cdr node))
globals::module_minus_tree_minus_children.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let node = args[0].clone();
// (letrec () (cdr node))
{
// (cdr node)
imports::cdr.with(|value| value.get()).invoke(&[node.clone(), ])}})}));
// (define (module-tree-libobj node) (cdr node))
globals::module_minus_tree_minus_libobj.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let node = args[0].clone();
// (letrec () (cdr node))
{
// (cdr node)
imports::cdr.with(|value| value.get()).invoke(&[node.clone(), ])}})}));
// (define (module-tree-set-children! node children) (set-cdr! node children))
globals::module_minus_tree_minus_set_minus_children_i.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let node = args[0].clone();let children = args[1].clone();
// (letrec () (set-cdr! node children))
{
// (set-cdr! node children)
imports::set_minus_cdr_i.with(|value| value.get()).invoke(&[node.clone(), children.clone(), ])}})}));
...
globals::module_minus_tree_minus_find_minus_child.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let node = args[0].clone();let name = args[1].clone();
...
imports::error.with(|value| value.get()).invoke(&[Scm::from("called (module-tree-find-child) on leaf node"), name.clone(), node.clone(), ])} else {Scm::symbol("*UNSPECIFIED*")};
// (assq name (module-tree-children node))
imports::assq.with(|value| value.get()).invoke(&[name.clone(), 
// (module-tree-children node)
globals::module_minus_tree_minus_children.with(|value| value.get()).invoke(&[node.clone(), ]), ])}}})}));
// (define (module-tree-append-child! node child) (module-tree-set-children! node (cons child (module-tree-children node))))
globals::module_minus_tree_minus_append_minus_child_i.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let node = args[0].clone();let child = args[1].clone();
...
globals::module_minus_tree_minus_set_minus_children_i.with(|value| value.get()).invoke(&[node.clone(), 
// (cons child (module-tree-children node))
imports::cons.with(|value| value.get()).invoke(&[child.clone(), 
// (module-tree-children node)
globals::module_minus_tree_minus_children.with(|value| value.get()).invoke(&[node.clone(), ]), ]), ])}})}));
...
globals::rust_minus_block.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let module = args[0].clone();let code = args[1].clone();
...
globals::rustify_minus_libname.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let name = args[0].clone();
...
imports::eq_p.with(|value| value.get()).invoke(&[ch.clone(), Scm::char('_'), ])).is_true() {Scm::from("__")} else {if (
// (eq? ch #\-)
imports::eq_p.with(|value| value.get()).invoke(&[ch.clone(), Scm::char('-'), ])).is_true() {Scm::from("_")} else {
// (list->string (list ch))
imports::list_minus__g_string.with(|value| value.get()).invoke(&[
// (list ch)
imports::list.with(|value| value.get()).invoke(&[ch.clone(), ]), ])}}}})});
...
{let [name, ] = [if (
// (symbol? name)
imports::symbol_p.with(|value| value.get()).invoke(&[name.clone(), ])).is_true() {
// (symbol->string name)
imports::symbol_minus__g_string.with(|value| value.get()).invoke(&[name.clone(), ])} else {name.clone()}, ];
// (cond ((eq? name (quote fn)) "fn_") (else (append-all (map char-map (string->list name)))))
if (
// (eq? name (quote fn))
imports::eq_p.with(|value| value.get()).invoke(&[name.clone(), Scm::symbol("fn"), ])).is_true() {Scm::from("fn_")} else {
// (append-all (map char-map (string->list name)))
append_minus_all.get().invoke(&[
// (map char-map (string->list name))
imports::map.with(|value| value.get()).invoke(&[char_minus_map.get(), 
// (string->list name)
imports::string_minus__g_list.with(|value| value.get()).invoke(&[name.clone(), ]), ]), ])}}}})}));
// (define (make-global-env) (list (quote GLOBAL-MARKER) (new-import (quote assert-eq)) (new-import (quote assert-equal))))
globals::make_minus_global_minus_env.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}
...
imports::list.with(|value| value.get()).invoke(&[Scm::symbol("GLOBAL-MARKER"), 
// (new-import (quote assert-eq))
globals::new_minus_import.with(|value| value.get()).invoke(&[Scm::symbol("assert-eq"), ]), 
// (new-import (quote assert-equal))
globals::new_minus_import.with(|value| value.get()).invoke(&[Scm::symbol("assert-equal"), ]), ])}})}));
// (define (ensure-var! name env) (let ((var (lookup name env))) (if var var (adjoin-global! name env))))
globals::ensure_minus_var_i.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name = args[0].clone();let env = args[1].clone();
...
{let [var, ] = [
// (lookup name env)
globals::lookup.with(|value| value.get()).invoke(&[name.clone(), env.clone(), ]), ];if (var.clone()).is_true() {var.clone()} else {
// (adjoin-global! name env)
globals::adjoin_minus_global_i.with(|value| value.get()).invoke(&[name.clone(), env.clone(), ])}}}})}));
...
globals::lookup.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name = args[0].clone();let env = args[1].clone();
...
if (
// (null? env)
imports::null_p.with(|value| value.get()).invoke(&[env.clone(), ])).is_true() {Scm::False} else {if (
// (eq? (quote GLOBAL-MARKER) (car env))
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("GLOBAL-MARKER"), 
// (car env)
imports::car.with(|value| value.get()).invoke(&[env.clone(), ]), ])).is_true() {
// (lookup name (cdr env))
globals::lookup.with(|value| value.get()).invoke(&[name.clone(), 
// (cdr env)
imports::cdr.with(|value| value.get()).invoke(&[env.clone(), ]), ])} else {if (
// (eq? name (caar env))
imports::eq_p.with(|value| value.get()).invoke(&[name.clone(), 
// (caar env)
imports::caar.with(|value| value.get()).invoke(&[env.clone(), ]), ])).is_true() {
// (cdar env)
imports::cdar.with(|value| value.get()).invoke(&[env.clone(), ])} else {
// (lookup name (cdr env))
globals::lookup.with(|value| value.get()).invoke(&[name.clone(), 
// (cdr env)
imports::cdr.with(|value| value.get()).invoke(&[env.clone(), ]), ])}}}}})}));
// (define (find-globals env) (if (eq? (quote GLOBAL-MARKER) (car env)) env (find-globals (cdr env))))
globals::find_minus_globals.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let env = args[0].clone();
// (letrec () (if (eq? (quote GLOBAL-MARKER) (car env)) env (find-globals (cdr env))))
{if (
// (eq? (quote GLOBAL-MARKER) (car env))
imports::eq_p.with(|value| value.get()).invoke(&[Scm::symbol("GLOBAL-MARKER"), 
// (car env)
imports::car.with(|value| value.get()).invoke(&[env.clone(), ]), ])).is_true() {env.clone()} else {
// (find-globals (cdr env))
globals::find_minus_globals.with(|value| value.get()).invoke(&[
// (cdr env)
imports::cdr.with(|value| value.get()).invoke(&[env.clone(), ]), ])}}})}));
// (define (adjoin-global! name env) (adjoin-global-var! (new-global name) env))
globals::adjoin_minus_global_i.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name = args[0].clone();let env = args[1].clone();
// (letrec () (adjoin-global-var! (new-global name) env))
{
// (adjoin-global-var! (new-global name) env)
globals::adjoin_minus_global_minus_var_i.with(|value| value.get()).invoke(&[
// (new-global name)
globals::new_minus_global.with(|value| value.get()).invoke(&[name.clone(), ]), env.clone(), ])}})}));
// (define (adjoin-import! name env) (adjoin-global-var! (new-import name) env))
globals::adjoin_minus_import_i.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name = args[0].clone();let env = args[1].clone();
// (letrec () (adjoin-global-var! (new-import name) env))
{
// (adjoin-global-var! (new-import name) env)
globals::adjoin_minus_global_minus_var_i.with(|value| value.get()).invoke(&[
// (new-import name)
globals::new_minus_import.with(|value| value.get()).invoke(&[name.clone(), ]), env.clone(), ])}})}));
// (define (adjoin-global-var! var env) (let ((genv (find-globals env))) (set-cdr! genv (cons var (cdr genv))) (cdr var)))
globals::adjoin_minus_global_minus_var_i.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let var = args[0].clone();let env = args[1].clone();
...
// (cons var (cdr genv))
imports::cons.with(|value| value.get()).invoke(&[var.clone(), 
// (cdr genv)
imports::cdr.with(|value| value.get()).invoke(&[genv.clone(), ]), ]), ]);
// (cdr var)
imports::cdr.with(|value| value.get()).invoke(&[var.clone(), ])}}}})}));
// (define (adjoin-local name env) (cons (new-local name) env))
globals::adjoin_minus_local.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name = args[0].clone();let env = args[1].clone();
// (letrec () (cons (new-local name) env))
{
// (cons (new-local name) env)
imports::cons.with(|value| value.get()).invoke(&[
// (new-local name)
globals::new_minus_local.with(|value| value.get()).invoke(&[name.clone(), ]), env.clone(), ])}})}));
...
globals::adjoin_minus_local_minus_env.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name_star_ = args[0].clone();let env = args[1].clone();
...
if (
// (null? name*)
imports::null_p.with(|value| value.get()).invoke(&[name_star_.clone(), ])).is_true() {env.clone()} else {if (
// (pair? name*)
imports::pair_p.with(|value| value.get()).invoke(&[name_star_.clone(), ])).is_true() {
// (adjoin-local-env (cdr name*) (adjoin-local (car name*) env))
globals::adjoin_minus_local_minus_env.with(|value| value.get()).invoke(&[
// (cdr name*)
imports::cdr.with(|value| value.get()).invoke(&[name_star_.clone(), ]), 
// (adjoin-local (car name*) env)
globals::adjoin_minus_local.with(|value| value.get()).invoke(&[
// (car name*)
imports::car.with(|value| value.get()).invoke(&[name_star_.clone(), ]), env.clone(), ]), ])} else {
// (adjoin-local name* env)
globals::adjoin_minus_local.with(|value| value.get()).invoke(&[name_star_.clone(), env.clone(), ])}}}})}));
...
loop_.set({let loop_ = loop_.clone();Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name_star_ = args[0].clone();let genv = args[1].clone();
...
imports::cons.with(|value| value.get()).invoke(&[
// (new-import (car name*))
globals::new_minus_import.with(|value| value.get()).invoke(&[
// (car name*)
...
globals::adjoin_minus_boxed.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name = args[0].clone();let env = args[1].clone();
// (letrec () (cons (new-boxed name) env))
{
// (cons (new-boxed name) env)
imports::cons.with(|value| value.get()).invoke(&[
// (new-boxed name)
globals::new_minus_boxed.with(|value| value.get()).invoke(&[name.clone(), ]), env.clone(), ])}})}));
...
globals::adjoin_minus_boxed_minus_env.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let name_star_ = args[0].clone();let env = args[1].clone();
...
globals::adjoin_minus_boxed_minus_env.with(|value| value.get()).invoke(&[
// (cdr name*)
imports::cdr.with(|value| value.get()).invoke(&[name_star_.clone(), ]), 
// (adjoin-boxed (car name*) env)
globals::adjoin_minus_boxed.with(|value| value.get()).invoke(&[
// (car name*)
imports::car.with(|value| value.get()).invoke(&[name_star_.clone(), ]), env.clone(), ]), ])} else {
// (adjoin-boxed name* env)
globals::adjoin_minus_boxed.with(|value| value.get()).invoke(&[name_star_.clone(), env.clone(), ])}}}})}));
// (define (new-import name) (cons name (variable (quote IMPORT-REF) (quote IMPORT-SET) #f)))
globals::new_minus_import.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let name = args[0].clone();
...
globals::variable.with(|value| value.get()).invoke(&[Scm::symbol("IMPORT-REF"), Scm::symbol("IMPORT-SET"), Scm::False, ]), ])}})}));
// (define (new-global name) (cons name (variable (quote GLOBAL-REF) (quote GLOBAL-SET) #f)))
globals::new_minus_global.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let name = args[0].clone();
...
globals::variable.with(|value| value.get()).invoke(&[Scm::symbol("GLOBAL-REF"), Scm::symbol("GLOBAL-SET"), Scm::False, ]), ])}})}));
// (define (new-local name) (cons name (variable (quote LOCAL-REF) (quote LOCAL-SET) #f)))
globals::new_minus_local.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let name = args[0].clone();
...
globals::variable.with(|value| value.get()).invoke(&[Scm::symbol("LOCAL-REF"), Scm::symbol("LOCAL-SET"), Scm::False, ]), ])}})}));
// (define (new-boxed name) (cons name (variable (quote BOXED-REF) (quote BOXED-SET) #f)))
globals::new_minus_boxed.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let name = args[0].clone();
...
globals::variable.with(|value| value.get()).invoke(&[Scm::symbol("BOXED-REF"), Scm::symbol("BOXED-SET"), Scm::False, ]), ])}})}));
// (define (variable getter setter mut?) (list getter setter mut?))
globals::variable.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let getter = args[0].clone();let setter = args[1].clone();let mut_p = args[2].clone();
// (letrec () (list getter setter mut?))
{
// (list getter setter mut?)
imports::list.with(|value| value.get()).invoke(&[getter.clone(), setter.clone(), mut_p.clone(), ])}})}));
// (define (variable-getter var) (car var))
globals::variable_minus_getter.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let var = args[0].clone();
// (letrec () (car var))
{
// (car var)
imports::car.with(|value| value.get()).invoke(&[var.clone(), ])}})}));
// (define (variable-setter var) (cadr var))
globals::variable_minus_setter.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let var = args[0].clone();
// (letrec () (cadr var))
{
// (cadr var)
imports::cadr.with(|value| value.get()).invoke(&[var.clone(), ])}})}));
// (define (variable-mut? var) (caddr var))
globals::variable_minus_mut_p.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let var = args[0].clone();
// (letrec () (caddr var))
{
// (caddr var)
imports::caddr.with(|value| value.get()).invoke(&[var.clone(), ])}})}));
// (define (variable-set-mutable! var) (set-car! (cddr var) #t))
globals::variable_minus_set_minus_mutable_i.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let var = args[0].clone();
// (letrec () (set-car! (cddr var) #t))
{
// (set-car! (cddr var) #t)
imports::set_minus_car_i.with(|value| value.get()).invoke(&[
// (cddr var)
imports::cddr.with(|value| value.get()).invoke(&[var.clone(), ]), Scm::True, ])}})}));
// (define (variable-set-getter! var getter) (set-car! var getter))
globals::variable_minus_set_minus_getter_i.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let var = args[0].clone();let getter = args[1].clone();
// (letrec () (set-car! var getter))
{
// (set-car! var getter)
imports::set_minus_car_i.with(|value| value.get()).invoke(&[var.clone(), getter.clone(), ])}})}));
// (define (variable-set-setter! var setter) (set-car! (cdr var) setter))
globals::variable_minus_set_minus_setter_i.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let var = args[0].clone();let setter = args[1].clone();
// (letrec () (set-car! (cdr var) setter))
{
// (set-car! (cdr var) setter)
imports::set_minus_car_i.with(|value| value.get()).invoke(&[
// (cdr var)
imports::cdr.with(|value| value.get()).invoke(&[var.clone(), ]), setter.clone(), ])}})}));
// (define (global-imported? var) (eq? (quote IMPORT-REF) (car var)))
globals::global_minus_imported_p.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let var = args[0].clone();
...
globals::global_minus_regular_p.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let var = args[0].clone();
...
globals::atom_p.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let x = args[0].clone();
// (letrec () (if (pair? x) #f #t))
{if (
// (pair? x)
imports::pair_p.with(|value| value.get()).invoke(&[x.clone(), ])).is_true() {Scm::False} else {Scm::True}}})}));
...
{let transform = Scm::uninitialized().into_boxed();
transform.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let node = args[0].clone();let ignore = args[1].clone();
...
globals::boxify_minus_abstraction.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 5{panic!("invalid arity")}let params = args[0].clone();let vars = args[1].clone();let param_star_ = args[2].clone();let var_star_ = args[3].clone();let body = args[4].clone();
...
{if (
// (null? var*)
imports::null_p.with(|value| value.get()).invoke(&[var_star_.clone(), ])).is_true() {
// (make-abstraction params vars body)
globals::make_minus_abstraction.with(|value| value.get()).invoke(&[params.clone(), vars.clone(), body.clone(), ])} else {if (
// (variable-mut? (car var*))
globals::variable_minus_mut_p.with(|value| value.get()).invoke(&[
// (car var*)
imports::car.with(|value| value.get()).invoke(&[var_star_.clone(), ]), ])).is_true() {{
// (variable-set-setter! (car var*) (quote BOXED-SET))
globals::variable_minus_set_minus_setter_i.with(|value| value.get()).invoke(&[
// (car var*)
imports::car.with(|value| value.get()).invoke(&[var_star_.clone(), ]), Scm::symbol("BOXED-SET"), ]);
// (variable-set-getter! (car var*) (quote BOXED-REF))
globals::variable_minus_set_minus_getter_i.with(|value| value.get()).invoke(&[
// (car var*)
imports::car.with(|value| value.get()).invoke(&[var_star_.clone(), ]), Scm::symbol("BOXED-REF"), ]);
// (boxify-abstraction params vars (cdr param*) (cdr var*) (make-boxify (car param*) body))
globals::boxify_minus_abstraction.with(|value| value.get()).invoke(&[params.clone(), vars.clone(), 
// (cdr param*)
imports::cdr.with(|value| value.get()).invoke(&[param_star_.clone(), ]), 
// (cdr var*)
imports::cdr.with(|value| value.get()).invoke(&[var_star_.clone(), ]), 
// (make-boxify (car param*) body)
globals::make_minus_boxify.with(|value| value.get()).invoke(&[
// (car param*)
imports::car.with(|value| value.get()).invoke(&[param_star_.clone(), ]), body.clone(), ]), ])}} else {
// (boxify-abstraction params vars (cdr param*) (cdr var*) body)
globals::boxify_minus_abstraction.with(|value| value.get()).invoke(&[params.clone(), vars.clone(), 
// (cdr param*)
imports::cdr.with(|value| value.get()).invoke(&[param_star_.clone(), ]), 
// (cdr var*)
imports::cdr.with(|value| value.get()).invoke(&[var_star_.clone(), ]), body.clone(), ])}}}})}));
...
globals::boxify_minus_vararg_minus_abstraction.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 7{panic!("invalid arity")}let params = args[0].clone();let vararg = args[1].clone();let vars = args[2].clone();let varvar = args[3].clone();let param_star_ = args[4].clone();let var_star_ = args[5].clone();let body = args[6].clone();
...
globals::make_minus_vararg_minus_abstraction.with(|value| value.get()).invoke(&[params.clone(), vararg.clone(), vars.clone(), varvar.clone(), body.clone(), ])} else {if (
// (variable-mut? (car var*))
globals::variable_minus_mut_p.with(|value| value.get()).invoke(&[
// (car var*)
imports::car.with(|value| value.get()).invoke(&[var_star_.clone(), ]), ])).is_true() {{
...
globals::boxify_minus_vararg_minus_abstraction.with(|value| value.get()).invoke(&[params.clone(), vararg.clone(), vars.clone(), varvar.clone(), 
// (cdr param*)
imports::cdr.with(|value| value.get()).invoke(&[param_star_.clone(), ]), 
// (cdr var*)
imports::cdr.with(|value| value.get()).invoke(&[var_star_.clone(), ]), 
...
globals::make_minus_set.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 0{panic!("invalid arity")}
// (letrec () (quote ()))
{Scm::Nil}})}));
// (define (set-add set item) (cond ((null? set) (cons item (quote ()))) ((equal? (car set) item) set) (else (cons (car set) (set-add (cdr set) item)))))
globals::set_minus_add.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let set = args[0].clone();let item = args[1].clone();
...
if (
// (null? set)
imports::null_p.with(|value| value.get()).invoke(&[set.clone(), ])).is_true() {
// (cons item (quote ()))
imports::cons.with(|value| value.get()).invoke(&[item.clone(), Scm::Nil, ])} else {if (
// (equal? (car set) item)
imports::equal_p.with(|value| value.get()).invoke(&[
// (car set)
imports::car.with(|value| value.get()).invoke(&[set.clone(), ]), item.clone(), ])).is_true() {set.clone()} else {
// (cons (car set) (set-add (cdr set) item))
imports::cons.with(|value| value.get()).invoke(&[
// (car set)
imports::car.with(|value| value.get()).invoke(&[set.clone(), ]), 
// (set-add (cdr set) item)
globals::set_minus_add.with(|value| value.get()).invoke(&[
// (cdr set)
imports::cdr.with(|value| value.get()).invoke(&[set.clone(), ]), item.clone(), ]), ])}}}})}));
// (define (set-remove set item) (cond ((null? set) (quote ())) ((equal? (car set) item) (cdr set)) (else (cons (car set) (set-remove (cdr set) item)))))
globals::set_minus_remove.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let set = args[0].clone();let item = args[1].clone();
...
if (
// (null? set)
imports::null_p.with(|value| value.get()).invoke(&[set.clone(), ])).is_true() {Scm::Nil} else {if (
// (equal? (car set) item)
imports::equal_p.with(|value| value.get()).invoke(&[
// (car set)
imports::car.with(|value| value.get()).invoke(&[set.clone(), ]), item.clone(), ])).is_true() {
// (cdr set)
imports::cdr.with(|value| value.get()).invoke(&[set.clone(), ])} else {
// (cons (car set) (set-remove (cdr set) item))
imports::cons.with(|value| value.get()).invoke(&[
// (car set)
imports::car.with(|value| value.get()).invoke(&[set.clone(), ]), 
// (set-remove (cdr set) item)
globals::set_minus_remove.with(|value| value.get()).invoke(&[
// (cdr set)
imports::cdr.with(|value| value.get()).invoke(&[set.clone(), ]), item.clone(), ]), ])}}}})}));
// (define (set-add* set item*) (set-do* set-add set item*))
globals::set_minus_add_star_.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let set = args[0].clone();let item_star_ = args[1].clone();
// (letrec () (set-do* set-add set item*))
{
// (set-do* set-add set item*)
globals::set_minus_do_star_.with(|value| value.get()).invoke(&[globals::set_minus_add.with(|value| value.get()), set.clone(), item_star_.clone(), ])}})}));
// (define (set-remove* set item*) (set-do* set-remove set item*))
globals::set_minus_remove_star_.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let set = args[0].clone();let item_star_ = args[1].clone();
// (letrec () (set-do* set-remove set item*))
{
// (set-do* set-remove set item*)
globals::set_minus_do_star_.with(|value| value.get()).invoke(&[globals::set_minus_remove.with(|value| value.get()), set.clone(), item_star_.clone(), ])}})}));
// (define (set-do* func set item*) (if (null? item*) set (set-do* func (func set (car item*)) (cdr item*))))
globals::set_minus_do_star_.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let func = args[0].clone();let set = args[1].clone();let item_star_ = args[2].clone();
// (letrec () (if (null? item*) set (set-do* func (func set (car item*)) (cdr item*))))
{if (
// (null? item*)
imports::null_p.with(|value| value.get()).invoke(&[item_star_.clone(), ])).is_true() {set.clone()} else {
// (set-do* func (func set (car item*)) (cdr item*))
globals::set_minus_do_star_.with(|value| value.get()).invoke(&[func.clone(), 
// (func set (car item*))
func.clone().invoke(&[set.clone(), 
// (car item*)
imports::car.with(|value| value.get()).invoke(&[item_star_.clone(), ]), ]), 
// (cdr item*)
imports::cdr.with(|value| value.get()).invoke(&[item_star_.clone(), ]), ])}}})}));
// (define (set-union set1 set2) (cond ((null? set1) set2) ((null? set2) set1) (else (set-add* set1 set2))))
globals::set_minus_union.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let set1 = args[0].clone();let set2 = args[1].clone();
...
if (
// (null? set1)
imports::null_p.with(|value| value.get()).invoke(&[set1.clone(), ])).is_true() {set2.clone()} else {if (
// (null? set2)
imports::null_p.with(|value| value.get()).invoke(&[set2.clone(), ])).is_true() {set1.clone()} else {
// (set-add* set1 set2)
globals::set_minus_add_star_.with(|value| value.get()).invoke(&[set1.clone(), set2.clone(), ])}}}})}));
// (define (println f . args) (for-each (lambda (a) (display a (as-port f))) args) (newline (as-port f)))
globals::println.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let f = args[0].clone();let args_ = Scm::list(&args[1..]);
// (letrec () (for-each (lambda (a) (display a (as-port f))) args) (newline (as-port f)))
{{
// (for-each (lambda (a) (display a (as-port f))) args)
imports::for_minus_each.with(|value| value.get()).invoke(&[{let f = f.clone();Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let a = args[0].clone();
// (letrec () (display a (as-port f)))
{
// (display a (as-port f))
imports::display.with(|value| value.get()).invoke(&[a.clone(), 
// (as-port f)
globals::as_minus_port.with(|value| value.get()).invoke(&[f.clone(), ]), ])}})}, args_.clone(), ]);
// (newline (as-port f))
imports::newline.with(|value| value.get()).invoke(&[
// (as-port f)
globals::as_minus_port.with(|value| value.get()).invoke(&[f.clone(), ]), ])}}})}));
// (define (print f . args) (for-each (lambda (a) (display a (as-port f))) args))
globals::print.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let f = args[0].clone();let args_ = Scm::list(&args[1..]);
...
globals::showln.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let f = args[0].clone();let args_ = Scm::list(&args[1..]);
...
{
// (write a (as-port f))
imports::write.with(|value| value.get()).invoke(&[a.clone(), 
// (as-port f)
globals::as_minus_port.with(|value| value.get()).invoke(&[f.clone(), ]), ])}})}, args_.clone(), ]);
// (newline (as-port f))
imports::newline.with(|value| value.get()).invoke(&[
...
globals::show.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() < 1{panic!("not enough args")}let f = args[0].clone();let args_ = Scm::list(&args[1..]);
...
globals::as_minus_port.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 1{panic!("invalid arity")}let port_minus_or_minus_module = args[0].clone();
// (letrec () (if (module? port-or-module) (module-port port-or-module) port-or-module))
{if (
// (module? port-or-module)
globals::module_p.with(|value| value.get()).invoke(&[port_minus_or_minus_module.clone(), ])).is_true() {
// (module-port port-or-module)
globals::module_minus_port.with(|value| value.get()).invoke(&[port_minus_or_minus_module.clone(), ])} else {port_minus_or_minus_module.clone()}}})}));
// (define (filter f seq) (if (pair? seq) (if (f (car seq)) (cons (car seq) (filter f (cdr seq))) (filter f (cdr seq))) (quote ())))
globals::filter.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let f = args[0].clone();let seq = args[1].clone();
// (letrec () (if (pair? seq) (if (f (car seq)) (cons (car seq) (filter f (cdr seq))) (filter f (cdr seq))) (quote ())))
{if (
// (pair? seq)
imports::pair_p.with(|value| value.get()).invoke(&[seq.clone(), ])).is_true() {if (
// (f (car seq))
f.clone().invoke(&[
// (car seq)
imports::car.with(|value| value.get()).invoke(&[seq.clone(), ]), ])).is_true() {
// (cons (car seq) (filter f (cdr seq)))
imports::cons.with(|value| value.get()).invoke(&[
// (car seq)
imports::car.with(|value| value.get()).invoke(&[seq.clone(), ]), 
// (filter f (cdr seq))
globals::filter.with(|value| value.get()).invoke(&[f.clone(), 
// (cdr seq)
imports::cdr.with(|value| value.get()).invoke(&[seq.clone(), ]), ]), ])} else {
// (filter f (cdr seq))
globals::filter.with(|value| value.get()).invoke(&[f.clone(), 
// (cdr seq)
imports::cdr.with(|value| value.get()).invoke(&[seq.clone(), ]), ])}} else {Scm::Nil}}})}));
// (define (any f seq) (if (pair? seq) (if (f (car seq)) #t (any f (cdr seq))) #f))
globals::any.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let f = args[0].clone();let seq = args[1].clone();
...
f.clone().invoke(&[
// (car seq)
imports::car.with(|value| value.get()).invoke(&[seq.clone(), ]), ])).is_true() {Scm::True} else {
// (any f (cdr seq))
globals::any.with(|value| value.get()).invoke(&[f.clone(), 
// (cdr seq)
imports::cdr.with(|value| value.get()).invoke(&[seq.clone(), ]), ])}} else {Scm::False}}})}));
// (define (reduce f init seq) (if (pair? seq) (reduce f (f init (car seq)) (cdr seq)) init))
globals::reduce.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 3{panic!("invalid arity")}let f = args[0].clone();let init = args[1].clone();let seq = args[2].clone();
// (letrec () (if (pair? seq) (reduce f (f init (car seq)) (cdr seq)) init))
{if (
// (pair? seq)
imports::pair_p.with(|value| value.get()).invoke(&[seq.clone(), ])).is_true() {
// (reduce f (f init (car seq)) (cdr seq))
globals::reduce.with(|value| value.get()).invoke(&[f.clone(), 
// (f init (car seq))
f.clone().invoke(&[init.clone(), 
// (car seq)
imports::car.with(|value| value.get()).invoke(&[seq.clone(), ]), ]), 
// (cdr seq)
imports::cdr.with(|value| value.get()).invoke(&[seq.clone(), ]), ])} else {init.clone()}}})}));
// (define (assoc obj seq) (if (pair? seq) (if (equal? obj (caar seq)) (car seq) (assoc obj (cdr seq))) #f))
globals::assoc.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let obj = args[0].clone();let seq = args[1].clone();
// (letrec () (if (pair? seq) (if (equal? obj (caar seq)) (car seq) (assoc obj (cdr seq))) #f))
{if (
// (pair? seq)
imports::pair_p.with(|value| value.get()).invoke(&[seq.clone(), ])).is_true() {if (
// (equal? obj (caar seq))
imports::equal_p.with(|value| value.get()).invoke(&[obj.clone(), 
// (caar seq)
imports::caar.with(|value| value.get()).invoke(&[seq.clone(), ]), ])).is_true() {
// (car seq)
imports::car.with(|value| value.get()).invoke(&[seq.clone(), ])} else {
// (assoc obj (cdr seq))
globals::assoc.with(|value| value.get()).invoke(&[obj.clone(), 
// (cdr seq)
imports::cdr.with(|value| value.get()).invoke(&[seq.clone(), ]), ])}} else {Scm::False}}})}));
// (define (append seq-a seq-b) (if (pair? seq-a) (cons (car seq-a) (append (cdr seq-a) seq-b)) seq-b))
globals::append.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let seq_minus_a = args[0].clone();let seq_minus_b = args[1].clone();
// (letrec () (if (pair? seq-a) (cons (car seq-a) (append (cdr seq-a) seq-b)) seq-b))
{if (
// (pair? seq-a)
imports::pair_p.with(|value| value.get()).invoke(&[seq_minus_a.clone(), ])).is_true() {
// (cons (car seq-a) (append (cdr seq-a) seq-b))
imports::cons.with(|value| value.get()).invoke(&[
// (car seq-a)
imports::car.with(|value| value.get()).invoke(&[seq_minus_a.clone(), ]), 
// (append (cdr seq-a) seq-b)
globals::append.with(|value| value.get()).invoke(&[
// (cdr seq-a)
imports::cdr.with(|value| value.get()).invoke(&[seq_minus_a.clone(), ]), seq_minus_b.clone(), ]), ])} else {seq_minus_b.clone()}}})}));
...
globals::sort.with(|value| value.set({Scm::func(move |args: &[Scm]|{if args.len() != 2{panic!("invalid arity")}let cmp = args[0].clone();let ass = args[1].clone();
