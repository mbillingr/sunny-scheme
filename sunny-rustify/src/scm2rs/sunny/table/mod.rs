...
mod globals {
    ...
    thread_local! {#[allow(non_upper_case_globals)] pub static ancestor_p: Mut<Scm> = Mut::new(Scm::symbol("UNINITIALIZED GLOBAL FUNCTION ancestor?"))}
    thread_local! {#[allow(non_upper_case_globals)] pub static call_minus_method: Mut<Scm> = Mut::new(Scm::symbol("UNINITIALIZED GLOBAL FUNCTION call-method"))}
    thread_local! {#[allow(non_upper_case_globals)] pub static clone: Mut<Scm> = Mut::new(Scm::symbol("UNINITIALIZED GLOBAL FUNCTION clone"))}
    thread_local! {#[allow(non_upper_case_globals)] pub static fields: Mut<Scm> = Mut::new(Scm::symbol("UNINITIALIZED GLOBAL FUNCTION fields"))}
    thread_local! {#[allow(non_upper_case_globals)] pub static get_minus_field: Mut<Scm> = Mut::new(Scm::symbol("UNINITIALIZED GLOBAL FUNCTION get-field"))}
    thread_local! {#[allow(non_upper_case_globals)] pub static make_minus_table: Mut<Scm> = Mut::new(Scm::symbol("UNINITIALIZED GLOBAL FUNCTION make-table"))}
    thread_local! {#[allow(non_upper_case_globals)] pub static parent: Mut<Scm> = Mut::new(Scm::symbol("UNINITIALIZED GLOBAL FUNCTION parent"))}
    thread_local! {#[allow(non_upper_case_globals)] pub static replace_minus_table_i: Mut<Scm> = Mut::new(Scm::symbol("UNINITIALIZED GLOBAL FUNCTION replace-table!"))}
    ...
    thread_local! {#[allow(non_upper_case_globals)] pub static set_minus_field_i: Mut<Scm> = Mut::new(Scm::symbol("UNINITIALIZED GLOBAL FUNCTION set-field!"))}
    thread_local! {#[allow(non_upper_case_globals)] pub static set_minus_fields_i: Mut<Scm> = Mut::new(Scm::symbol("UNINITIALIZED GLOBAL FUNCTION set-fields!"))}
    thread_local! {#[allow(non_upper_case_globals)] pub static set_minus_parent_i: Mut<Scm> = Mut::new(Scm::symbol("UNINITIALIZED GLOBAL FUNCTION set-parent!"))}
    thread_local! {#[allow(non_upper_case_globals)] pub static table_p: Mut<Scm> = Mut::new(Scm::symbol("UNINITIALIZED GLOBAL FUNCTION table?"))}
}
                    ...
                    {
                        {
                            ...
                            globals::call_minus_method
                                .with(|value| value.get())
                                .invoke(&[krog.clone(), Scm::symbol("take-damage!"), Scm::from(15)])
                        };
                        {
                            // (call-method kold (quote take-damage!) 30)
                            globals::call_minus_method
                                .with(|value| value.get())
                                .invoke(&[kold.clone(), Scm::symbol("take-damage!"), Scm::from(30)])
                        };
                        {
                            // (call-method vard (quote take-damage!) 45)
                            globals::call_minus_method
                                .with(|value| value.get())
                                .invoke(&[vard.clone(), Scm::symbol("take-damage!"), Scm::from(45)])
                        };
                        {
                            // (call-method dega (quote take-damage!) 20)
                            globals::call_minus_method
                                .with(|value| value.get())
                                .invoke(&[dega.clone(), Scm::symbol("take-damage!"), Scm::from(20)])
                        };
                        assert!({
