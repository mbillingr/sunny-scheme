...
Scm::func(imports::cons).invoke(&[Scm::symbol("<table>"),Scm::Nil])}])};assert!({
// (not (table? t))
...
// (null? f)
Scm::func(imports::null_p).invoke(&[f.clone()])}.is_true());
}}}}
#[test]
...
// (not value)
Scm::func(imports::not).invoke(&[value.clone()])}.is_true());
}}}}
#[test]
...
Scm::func(imports::_plus_).invoke(&[Scm::from(1),{
