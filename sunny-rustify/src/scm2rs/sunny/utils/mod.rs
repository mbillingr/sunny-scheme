...
pub mod exports{pub use super::globals::dotted_minus_list_p as dotted_minus_list_p;
pub use super::globals::last_minus_cdr as last_minus_cdr;
pub use super::globals::proper_minus_list_minus_part as proper_minus_list_minus_part;
}
...
// (last-cdr seq)
globals::last_minus_cdr.with(|value| value.get()).invoke(&[seq.clone(), ]), ]), ])}})}));
