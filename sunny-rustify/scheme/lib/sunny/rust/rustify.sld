(define-library (sunny rust rustify)
  ...
  (begin
    (define (rustify-identifier name)
      ...
      (cond ((same-name? name 'args) "args_")
            ((same-name? name 'fn) "fn_")
            ((same-name? name 'loop) "loop_")
            ((same-name? name 'let) "let_")
            ((same-name? name 'mut) "mut_")
            ((same-name? name 'ref) "ref_")
            ((same-name? name 'self) "self_")
